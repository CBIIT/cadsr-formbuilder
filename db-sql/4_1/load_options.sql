...
UNION SELECT 'FormBuilder' AS TOOL_NAME, 'HELP.ROOT' AS PROPERTY, 'https://wiki.nci.nih.gov/x/TgvRB' AS VALUE, 'root url for formbulder tool help' AS DESCRIPTION, 'US' AS LOCALE FROM DUAL
) T
