...
UNION SELECT 'FormBuilder' AS TOOL_NAME, 'HELP.ROOT' AS PROPERTY, 'https://formbuilder.nci.nih.gov/help' AS VALUE, 'root url for formbulder tool help' AS DESCRIPTION, 'US' AS LOCALE FROM DUAL
) T
