...
<html:form action="/updateSkipPatternForCSI.do?method=updateSkipPatternForCSI">
   <input type="hidden" name="choice" value="no">
   <html:hidden property="removedClassificationId" value='<%=(String)request.getAttribute("removedClassificationId")%>'/>
      <table width="80%" align="center" cellpadding="1" cellspacing="1" border="0" >      
        <tr >
          <td align="center" class="OraTipLabel">
             <bean:message key="cadsr.formbuilder.form.edit.prompt.updateSkippPatternForCSI"/> 
          </td>          
        </tr>     
        <tr >
