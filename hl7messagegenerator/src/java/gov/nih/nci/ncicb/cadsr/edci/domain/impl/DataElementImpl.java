 ...
 * Schema.
 * $Id: DataElementImpl.java,v 1.2 2006-08-30 13:08:28 marwahah Exp $
 */
...
import gov.nih.nci.ncicb.cadsr.edci.domain.DataElementAlias;
 ...
 */
public class DataElementImpl implements java.io.Serializable, DataElement {
    ...
    public DataElementImpl() 
     {
        super();
        _dataElementTextImplList = new java.util.ArrayList();
        _alternateDesignationImplList = new java.util.ArrayList();
    ...
    {
        return Collections.enumeration(_alternateDesignationImplList);
    ...
    {
        return Collections.enumeration(_dataElementTextImplList);
