 ...
 * Schema.
 * $Id: ValueDomainImpl.java,v 1.2 2006-08-30 13:08:28 marwahah Exp $
 */
 ...
 */
public class ValueDomainImpl implements java.io.Serializable, ValueDomain {
    ...
    public ValueDomainImpl() 
     {
        super();
        _EVDElementImplList = new java.util.ArrayList();
        _EVDSubsetImplList = new java.util.ArrayList();
    ...
    {
        return Collections.enumeration(_EVDElementImplList);
    ...
    {
        return Collections.enumeration(_EVDSubsetImplList);
