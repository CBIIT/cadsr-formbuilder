    ...
    public GlobalDefinitions getGlobalDefinitions(String formIdSeq) throws DataAccessException {
       ...
       // Get Alternate DEsignations for eDCI
                     ...
                     for (Designation designation:designations){
                      ...
                      Collection<ReferenceDocument> vdreferenceDocuments = vD.getReferenceDocumentCollection();
                      
                      for (ReferenceDocument referenceDocument:vdreferenceDocuments){
                      
                          if (referenceDocument.getType().equals("VD Reference")) {
                              eDCIVD.setSourceCodingSystem(referenceDocument.getDoctext());
                              break;
                          }
