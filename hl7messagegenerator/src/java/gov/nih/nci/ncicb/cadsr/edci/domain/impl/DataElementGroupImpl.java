 ...
 * Schema.
 * $Id: DataElementGroupImpl.java,v 1.2 2006-08-30 13:08:28 marwahah Exp $
 */
 ...
 */
public class DataElementGroupImpl implements java.io.Serializable, DataElementGroup {
    ...
    private java.util.Collection dataElementCollection;
    ...
    public DataElementGroupImpl() 
     {
        super();
        _memberImplList = new java.util.ArrayList();
        dataElementCollection = new ArrayList();
    ...
    {
        return Collections.enumeration(_memberImplList);
