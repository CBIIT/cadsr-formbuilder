 ...
 * Schema.
 * $Id: EVDSubsetImpl.java,v 1.1 2006-10-03 19:42:06 marwahah Exp $
 */
 ...
 */
public class EVDSubsetImpl implements java.io.Serializable {
    ...
    public EVDSubsetImpl() 
     {
        super();
        _elementInSubsetImplList = new ArrayList();
    ...
    {
        return new org.exolab.castor.util.IteratorEnumeration(_elementInSubsetImplList.iterator());
