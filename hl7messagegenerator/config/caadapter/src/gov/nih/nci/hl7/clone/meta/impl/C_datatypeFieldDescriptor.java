 ...
 * Schema.
 * $Id: C_datatypeFieldDescriptor.java,v 1.1 2006-10-03 17:38:25 marwahah Exp $
 */
...
/**
 * Class C_datatypeFieldDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006-10-03 17:38:25 $
 */
public class C_datatypeFieldDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public C_datatypeFieldDescriptor() 
     {
        super();
        xmlName = "datatypeField";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                C_datatypeField target = (C_datatypeField) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _userDefault
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_userDefault", "user-default", org.exolab.castor.xml.NodeType.Attribute);
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    C_datatypeField target = (C_datatypeField) object;
                    target.setUserDefault( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _userDefault
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
    ...
    } //-- gov.nih.nci.hl7.clone.meta.impl.C_datatypeFieldDescriptor()
    ...
    {
        return gov.nih.nci.hl7.clone.meta.impl.C_datatypeField.class;
