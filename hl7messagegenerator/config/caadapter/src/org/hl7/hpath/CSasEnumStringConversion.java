...
public class CSasEnumStringConversion extends Conversion<CS, String> {
  ...
  public static final Conversion.Definition DEFINITION = new Conversion.Definition() {
	...
	private CSasEnumStringConversion(Expression previousExpression, List<Expression> arguments) {
