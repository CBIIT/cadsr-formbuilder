 ...
 */
/*package protected*/ final class Tokenizer implements java.util.Iterator<Token> {
  RegexTokenizer _regexTokenizer;
  private Token _nextToken;

  public String getTokenString() { return _nextToken.string(); }
  public Object getTokenValue() { return _nextToken.value(); }
				...
				if(tokenType.pattern() != null) {
					...
					if(tokenString != null && tokenString.length() > 0) {
						if(tokenType.isIgnorable()) {
							...
							Token token = new Token(tokenType, tokenString);
  ...
  */
  ...
  public Token next(TokenType tokenType) throws SyntaxError {
    Token token = _nextToken;
