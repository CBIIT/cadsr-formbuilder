...
interface GenericTokenType {
  ...
  public Object tokenValueOf(String string);
...
/*package protected*/ enum TokenType implements GenericTokenType {
	  PROP("\\.", ValueConstructor.LITERAL, TokenTypeCategory.SYNTAX),
		...
		VARPFX("\\$", ValueConstructor.LITERAL, TokenTypeCategory.SYNTAX),
		...
		INTLIT("[+\\-]?[0-9]+", ValueConstructor.INTVAL, TokenTypeCategory.LITERAL),
		REALLIT("[+\\-]?[0-9]+(?:\\.[0-9]*)?[eE][+\\-][0-9]+", ValueConstructor.REALVAL, TokenTypeCategory.LITERAL),
