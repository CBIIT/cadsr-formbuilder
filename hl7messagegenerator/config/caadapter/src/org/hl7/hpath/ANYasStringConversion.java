...
/*package*/ class ANYasStringConversion extends Conversion<ANY, String> {
	...
	private ANYasStringConversion(Expression previousExpression, List<Expression> arguments) {
