...
public class IIasExtensionStringConversion extends Conversion<II, String> {
  ...
  public static final Conversion.Definition DEFINITION = new Conversion.Definition() {
	...
	private IIasExtensionStringConversion(Expression previousExpression, List<Expression> arguments) {
