...
* Contributor(s): 
*
* $Id: MessageTypeLoaderAdapter.java,v 1.1 2006-10-03 17:39:01 marwahah Exp $
*/
...
public class MessageTypeLoaderAdapter implements MessageTypeLoader {
   ...
   */
  public MessageTypeAdapter loadMessageType(String id) throws LoaderException {
    try {
      MessageTypeAdapter mta = new MessageTypeAdapter(id);
