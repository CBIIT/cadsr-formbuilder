...
<p>Some containers may have customary ways of referring to the positions or no way at all. In the absence of any specific regulation
  ...
  */
  ...
  /** Sets the property scoper.
      @see #getScoper
  */
  void setScoper(Entity scoper);

  /**
  */
  /*AssociationSet*/List<RoleLink> getOutboundLink();
  /** Sets the property outboundLink.
      @see #getOutboundLink
  */
  void setOutboundLink(/*AssociationSet*/List<RoleLink> outboundLink);
  /** Adds an association outboundLink.
      @see #addOutboundLink
  */
  void addOutboundLink(RoleLink outboundLink);

  /**
  */
  /*AssociationSet*/List<RoleLink> getInboundLink();
  /** Sets the property inboundLink.
      @see #getInboundLink
  */
  void setInboundLink(/*AssociationSet*/List<RoleLink> inboundLink);
  /** Adds an association inboundLink.
      @see #addInboundLink
  */
  void addInboundLink(RoleLink inboundLink);
}
