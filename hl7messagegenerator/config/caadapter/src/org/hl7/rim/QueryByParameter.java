...
*/
public interface QueryByParameter extends QuerySpec {

  /**
  */
  /*AssociationSet*/List<Parameter> getParameter();
  /** Sets the property parameter.
      @see #getParameter
  */
  void setParameter(/*AssociationSet*/List<Parameter> parameter);
