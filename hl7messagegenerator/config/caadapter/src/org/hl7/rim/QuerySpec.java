...
*/
public interface QuerySpec extends QueryEvent {
  ...
  */
  ...
  /**
  */
  /*AssociationSet*/List<SortControl> getSortControl();
  /** Sets the property sortControl.
      @see #getSortControl
  */
  void setSortControl(/*AssociationSet*/List<SortControl> sortControl);
  /** Adds an association sortControl.
      @see #addSortControl
  */
  void addSortControl(SortControl sortControl);
}
