...
<p>The reasonCode remains as a place for common reasons that are not related to a prior Act or any other condition expressed
  ...
  */
  ...
  /**
  */
  /*AssociationSet*/List<ActRelationship> getOutboundRelationship();
  /** Sets the property outboundRelationship.
      @see #getOutboundRelationship
  */
  void setOutboundRelationship(/*AssociationSet*/List<ActRelationship> outboundRelationship);
  /** Adds an association outboundRelationship.
      @see #addOutboundRelationship
  */
  void addOutboundRelationship(ActRelationship outboundRelationship);

  /**
  */
  /*AssociationSet*/List<ActRelationship> getInboundRelationship();
  /** Sets the property inboundRelationship.
      @see #getInboundRelationship
  */
  void setInboundRelationship(/*AssociationSet*/List<ActRelationship> inboundRelationship);
  /** Adds an association inboundRelationship.
      @see #addInboundRelationship
  */
  void addInboundRelationship(ActRelationship inboundRelationship);

  /**
  */
  /*AssociationSet*/List<Participation> getParticipation();
  /** Sets the property participation.
      @see #getParticipation
  */
  void setParticipation(/*AssociationSet*/List<Participation> participation);
