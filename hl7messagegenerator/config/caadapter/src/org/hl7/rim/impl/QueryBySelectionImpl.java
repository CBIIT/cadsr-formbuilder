...
/** Implementation of org.hl7.rim.QueryBySelection as a simple data holder bean.
  ...
  */
public class QueryBySelectionImpl extends QuerySpecImpl implements QueryBySelection {

  private /*AssociationSet*/List<SelectionExpression> _selectionExpression;
  /** Gets the property selectionExpression.
      @see org.hl7.rim.QueryBySelection#getSelectionExpression
  */
  public /*AssociationSet*/List<SelectionExpression> getSelectionExpression() {
    return _selectionExpression;
  }
  /** Sets the property selectionExpression.
      @see org.hl7.rim.QueryBySelection#setSelectionExpression
  */
  public void setSelectionExpression(/*AssociationSet*/List<SelectionExpression> selectionExpression) {
    _selectionExpression = selectionExpression;
  }
  /** Adds an association selectionExpression.
      @see org.hl7.rim.QueryBySelection#setSelectionExpression
  */
  public void addSelectionExpression(SelectionExpression selectionExpression) {
        // create the association set if it doesn't exist already
    if(_selectionExpression == null) _selectionExpression = new AssociationSetImpl<SelectionExpression>();
