...
/** Implementation of org.hl7.rim.QuerySpec as a simple data holder bean.
  ...
  */
public class QuerySpecImpl extends QueryEventImpl implements QuerySpec {
  ...
  */
  ...
  private /*AssociationSet*/List<SortControl> _sortControl;
  /** Gets the property sortControl.
      @see org.hl7.rim.QuerySpec#getSortControl
  */
  public /*AssociationSet*/List<SortControl> getSortControl() {
    return _sortControl;
  }
  /** Sets the property sortControl.
      @see org.hl7.rim.QuerySpec#setSortControl
  */
  public void setSortControl(/*AssociationSet*/List<SortControl> sortControl) {
    _sortControl = sortControl;
  }
  /** Adds an association sortControl.
      @see org.hl7.rim.QuerySpec#setSortControl
  */
  public void addSortControl(SortControl sortControl) {
        // create the association set if it doesn't exist already
    if(_sortControl == null) _sortControl = new AssociationSetImpl<SortControl>();
