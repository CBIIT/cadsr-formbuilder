...
/** Implementation of org.hl7.rim.LogicalExpression as a simple data holder bean.
  ...
  */
public class LogicalExpressionImpl extends SelectionExpressionImpl implements LogicalExpression {
  ...
  */
  ...
  private /*AssociationSet*/List<SelectionExpression> _userAsLeft;
  /** Gets the property userAsLeft.
      @see org.hl7.rim.LogicalExpression#getUserAsLeft
  */
  public /*AssociationSet*/List<SelectionExpression> getUserAsLeft() {
    return _userAsLeft;
  }
  /** Sets the property userAsLeft.
      @see org.hl7.rim.LogicalExpression#setUserAsLeft
  */
  public void setUserAsLeft(/*AssociationSet*/List<SelectionExpression> userAsLeft) {
    _userAsLeft = userAsLeft;
  }
  /** Adds an association userAsLeft.
      @see org.hl7.rim.LogicalExpression#setUserAsLeft
  */
  public void addUserAsLeft(SelectionExpression userAsLeft) {
  ...
  private /*AssociationSet*/List<SelectionExpression> _userAsRight;
  /** Gets the property userAsRight.
      @see org.hl7.rim.LogicalExpression#getUserAsRight
  */
  public /*AssociationSet*/List<SelectionExpression> getUserAsRight() {
    return _userAsRight;
  }
  /** Sets the property userAsRight.
      @see org.hl7.rim.LogicalExpression#setUserAsRight
  */
  public void setUserAsRight(/*AssociationSet*/List<SelectionExpression> userAsRight) {
    _userAsRight = userAsRight;
  }
  /** Adds an association userAsRight.
      @see org.hl7.rim.LogicalExpression#setUserAsRight
  */
  public void addUserAsRight(SelectionExpression userAsRight) {
        // create the association set if it doesn't exist already
    if(_userAsRight == null) _userAsRight = new AssociationSetImpl<SelectionExpression>();
    // add the association to the association set
