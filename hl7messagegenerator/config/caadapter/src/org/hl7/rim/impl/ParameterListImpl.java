...
/** Implementation of org.hl7.rim.ParameterList as a simple data holder bean.
    @see org.hl7.rim.ParameterList
  */
public class ParameterListImpl extends ParameterImpl implements ParameterList {

  private /*AssociationSet*/List<Parameter> _parameter;
  /** Gets the property parameter.
      @see org.hl7.rim.ParameterList#getParameter
  */
  public /*AssociationSet*/List<Parameter> getParameter() {
    return _parameter;
  }
  /** Sets the property parameter.
      @see org.hl7.rim.ParameterList#setParameter
  */
  public void setParameter(/*AssociationSet*/List<Parameter> parameter) {
  ...
  */
  ...
  public Object clone() {
    ParameterListImpl that = (ParameterListImpl) super.clone();
