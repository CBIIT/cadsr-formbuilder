...
/** Implementation of org.hl7.rim.Role as a simple data holder bean.
  ...
  */
public class RoleImpl extends InfrastructureRootImpl implements Role {
  ...
  */
  ...
  private /*AssociationSet*/List<RoleLink> _outboundLink;
  /** Gets the property outboundLink.
      @see org.hl7.rim.Role#getOutboundLink
  */
  public /*AssociationSet*/List<RoleLink> getOutboundLink() {
    return _outboundLink;
  }
  /** Sets the property outboundLink.
      @see org.hl7.rim.Role#setOutboundLink
  */
  public void setOutboundLink(/*AssociationSet*/List<RoleLink> outboundLink) {
    _outboundLink = outboundLink;
  }
  /** Adds an association outboundLink.
      @see org.hl7.rim.Role#setOutboundLink
  */
  public void addOutboundLink(RoleLink outboundLink) {
        // create the association set if it doesn't exist already
  ...
  private /*AssociationSet*/List<RoleLink> _inboundLink;
  /** Gets the property inboundLink.
      @see org.hl7.rim.Role#getInboundLink
  */
  public /*AssociationSet*/List<RoleLink> getInboundLink() {
    return _inboundLink;
  }
  /** Sets the property inboundLink.
      @see org.hl7.rim.Role#setInboundLink
  */
  public void setInboundLink(/*AssociationSet*/List<RoleLink> inboundLink) {
    _inboundLink = inboundLink;
  }
  /** Adds an association inboundLink.
      @see org.hl7.rim.Role#setInboundLink
  */
  public void addInboundLink(RoleLink inboundLink) {
        // create the association set if it doesn't exist already
    if(_inboundLink == null) _inboundLink = new AssociationSetImpl<RoleLink>();
    // add the association to the association set
