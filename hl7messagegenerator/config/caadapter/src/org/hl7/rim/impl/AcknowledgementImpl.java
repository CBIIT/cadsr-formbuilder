...
/** Implementation of org.hl7.rim.Acknowledgement as a simple data holder bean.
  ...
  */
public class AcknowledgementImpl extends InfrastructureRootImpl implements Acknowledgement {
  ...
  */
  ...
  private /*AssociationSet*/List<AcknowledgementDetail> _acknowledgementDetail;
  /** Gets the property acknowledgementDetail.
      @see org.hl7.rim.Acknowledgement#getAcknowledgementDetail
  */
  public /*AssociationSet*/List<AcknowledgementDetail> getAcknowledgementDetail() {
  ...
  */
  public void setAcknowledgementDetail(/*AssociationSet*/List<AcknowledgementDetail> acknowledgementDetail) {
    _acknowledgementDetail = acknowledgementDetail;
  }
  /** Adds an association acknowledgementDetail.
      @see org.hl7.rim.Acknowledgement#setAcknowledgementDetail
  */
  public void addAcknowledgementDetail(AcknowledgementDetail acknowledgementDetail) {
  ...
  private Transmission _acknowledges;
  ...
  */
  ...
  private Transmission _conveyingTransmission;
