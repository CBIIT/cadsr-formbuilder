...
*/
public interface QueryBySelection extends QuerySpec {

  /**
  */
  /*AssociationSet*/List<SelectionExpression> getSelectionExpression();
  /** Sets the property selectionExpression.
      @see #getSelectionExpression
  */
  void setSelectionExpression(/*AssociationSet*/List<SelectionExpression> selectionExpression);
  /** Adds an association selectionExpression.
      @see #addSelectionExpression
  */
  void addSelectionExpression(SelectionExpression selectionExpression);
}
