...
*/
public interface Acknowledgement extends InfrastructureRoot {
...
<p>Priority may be used by local agreement to determine the timeframe in which the receiving application is expected to retrieve
  ...
  */
  ...
  /**
  */
  /*AssociationSet*/List<AcknowledgementDetail> getAcknowledgementDetail();
  /** Sets the property acknowledgementDetail.
      @see #getAcknowledgementDetail
  */
  void setAcknowledgementDetail(/*AssociationSet*/List<AcknowledgementDetail> acknowledgementDetail);
  /** Adds an association acknowledgementDetail.
      @see #addAcknowledgementDetail
  */
  void addAcknowledgementDetail(AcknowledgementDetail acknowledgementDetail);

  /**
  */
  Transmission getAcknowledges();
  /** Sets the property acknowledges.
      @see #getAcknowledges
  */
  void setAcknowledges(Transmission acknowledges);

  /**
  */
  Transmission getConveyingTransmission();
  /** Sets the property conveyingTransmission.
      @see #getConveyingTransmission
  */
  void setConveyingTransmission(Transmission conveyingTransmission);
}
