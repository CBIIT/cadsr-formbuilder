...
/**
*/
public interface LogicalExpression extends SelectionExpression {
  ...
  */
  ...
  /**
  */
  /*AssociationSet*/List<SelectionExpression> getUserAsLeft();
  /** Sets the property userAsLeft.
      @see #getUserAsLeft
  */
  void setUserAsLeft(/*AssociationSet*/List<SelectionExpression> userAsLeft);
  /** Adds an association userAsLeft.
      @see #addUserAsLeft
  */
  void addUserAsLeft(SelectionExpression userAsLeft);

  /**
  */
  /*AssociationSet*/List<SelectionExpression> getUserAsRight();
  /** Sets the property userAsRight.
      @see #getUserAsRight
  */
  void setUserAsRight(/*AssociationSet*/List<SelectionExpression> userAsRight);
  /** Adds an association userAsRight.
      @see #addUserAsRight
  */
  void addUserAsRight(SelectionExpression userAsRight);
}
