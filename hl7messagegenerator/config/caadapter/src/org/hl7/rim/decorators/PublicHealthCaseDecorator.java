...
import org.hl7.rim.decorators.ObservationDecorator;
...
public abstract class PublicHealthCaseDecorator extends ObservationDecorator implements PublicHealthCase {
  ...
  */
  public CE getDetectionMethodCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.detectionMethodCode.
      @see org.hl7.rim.PublicHealthCase#setDetectionMethodCode
  */
  public void setDetectionMethodCode(CE detectionMethodCode) { /*throw new UnsupportedOperationException();*/ }
  ...
  */
  public CE getTransmissionModeCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.transmissionModeCode.
      @see org.hl7.rim.PublicHealthCase#setTransmissionModeCode
  */
  public void setTransmissionModeCode(CE transmissionModeCode) { /*throw new UnsupportedOperationException();*/ }
  ...
  */
  public CE getDiseaseImportedCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.diseaseImportedCode.
      @see org.hl7.rim.PublicHealthCase#setDiseaseImportedCode
  */
  public void setDiseaseImportedCode(CE diseaseImportedCode) { /*throw new UnsupportedOperationException();*/ }
}
