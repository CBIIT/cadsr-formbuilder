...
public abstract class AttachmentDecorator extends InfrastructureRootDecorator implements Attachment {
  ...
  */
  ...
  /** Property accessor, returns null if not overloaded.transmission.
      @see org.hl7.rim.Attachment#getTransmission
  */
  public Transmission getTransmission() { return null; }
  /** Property mutator, does nothing if not overloaded.transmission.
      @see org.hl7.rim.Attachment#setTransmission
  */
  public void setTransmission(Transmission transmission) { /* throw new UnsupportedOperationException(); */ }
}
