...
/** Implementation of org.hl7.rim.Transmission as an abstract decorator, i.e., a class that returns NULL/NA or nothing for all property accessprs amd that raises UnsupportedOperationExceptions for all mutators. This is used to adapt custom application classes to the RIM class interfaces and only bother about mapping those properties that actually apply to the application class. This can be done in one of two ways: (1) the client class can extend the decorator directly, and implement the applicable properties, or (2) the abstract decorator can be extend to a concrete decorator, which would hold a reference to the client object and method bodies to delegate and adapt the applicable properties.
  ...
  */
public abstract class TransmissionDecorator extends InfrastructureRootDecorator implements Transmission {
  /** Property accessor, returns NULL/NA if not overloaded.id.
      @see org.hl7.rim.Transmission#getId
  */
  public II getId() { return IInull.NA; }
  ...
  */
  public TS getCreationTime() { return TSnull.NA; }
  ...
  */
  public ST getSecurityText() { return STnull.NA; }
  ...
  */
  public CS getResponseModeCode() { return CSnull.NA; }
  ...
  */
  public /*AssociationSet*/List<Acknowledgement> getAcknowledgedBy() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.acknowledgedBy.
      @see org.hl7.rim.Transmission#setAcknowledgedBy
  */
  public void setAcknowledgedBy(/*AssociationSet*/List<Acknowledgement> acknowledgedBy) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded acknowledgedBy.
      @see org.hl7.rim.Transmission#setAcknowledgedBy
  */
  public void addAcknowledgedBy(Acknowledgement acknowledgedBy) { throw new UnsupportedOperationException(); }
  ...
  */
  public /*AssociationSet*/List<Acknowledgement> getConveyedAcknowledgement() { return Collections.EMPTY_LIST; }
  ...
  */
  public void setConveyedAcknowledgement(/*AssociationSet*/List<Acknowledgement> conveyedAcknowledgement) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded conveyedAcknowledgement.
      @see org.hl7.rim.Transmission#setConveyedAcknowledgement
  */
  public void addConveyedAcknowledgement(Acknowledgement conveyedAcknowledgement) { throw new UnsupportedOperationException(); }
  /** Property accessor, returns an empty collection if not overloaded.attachment.
      @see org.hl7.rim.Transmission#getAttachment
  */
  public /*AssociationSet*/List<Attachment> getAttachment() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.attachment.
      @see org.hl7.rim.Transmission#setAttachment
  */
  public void setAttachment(/*AssociationSet*/List<Attachment> attachment) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded attachment.
      @see org.hl7.rim.Transmission#setAttachment
  */
  public void addAttachment(Attachment attachment) { throw new UnsupportedOperationException(); }
  ...
  */
  public /*AssociationSet*/List<AttentionLine> getAttentionLine() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.attentionLine.
      @see org.hl7.rim.Transmission#setAttentionLine
  */
  public void setAttentionLine(/*AssociationSet*/List<AttentionLine> attentionLine) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded attentionLine.
      @see org.hl7.rim.Transmission#setAttentionLine
  */
  public void addAttentionLine(AttentionLine attentionLine) { throw new UnsupportedOperationException(); }
  /** Property accessor, returns null if not overloaded.batch.
      @see org.hl7.rim.Transmission#getBatch
  */
  public Batch getBatch() { return null; }
  /** Property mutator, does nothing if not overloaded.batch.
      @see org.hl7.rim.Transmission#setBatch
  */
  public void setBatch(Batch batch) { /* throw new UnsupportedOperationException(); */ }
  ...
  */
  public /*AssociationSet*/List<CommunicationFunction> getCommunicationFunction() { return Collections.EMPTY_LIST; }
  ...
  */
  public void setCommunicationFunction(/*AssociationSet*/List<CommunicationFunction> communicationFunction) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded communicationFunction.
      @see org.hl7.rim.Transmission#setCommunicationFunction
  */
  public void addCommunicationFunction(CommunicationFunction communicationFunction) { throw new UnsupportedOperationException(); }
}
