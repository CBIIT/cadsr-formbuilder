...
public abstract class QueryContinuationDecorator extends QueryEventDecorator implements QueryContinuation {
  ...
  */
  public INT getStartResultNumber() { return INTnull.NA; }
  /** Property mutator, does nothing if not overloaded.startResultNumber.
      @see org.hl7.rim.QueryContinuation#setStartResultNumber
  */
  public void setStartResultNumber(INT startResultNumber) { /*throw new UnsupportedOperationException();*/ }
  ...
  */
  public INT getContinuationQuantity() { return INTnull.NA; }
  /** Property mutator, does nothing if not overloaded.continuationQuantity.
      @see org.hl7.rim.QueryContinuation#setContinuationQuantity
  */
  public void setContinuationQuantity(INT continuationQuantity) { /*throw new UnsupportedOperationException();*/ }
}
