...
public abstract class NonPersonLivingSubjectDecorator extends LivingSubjectDecorator implements NonPersonLivingSubject {
  ...
  */
  public CE getGenderStatusCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.genderStatusCode.
      @see org.hl7.rim.NonPersonLivingSubject#setGenderStatusCode
  */
  public void setGenderStatusCode(CE genderStatusCode) { /*throw new UnsupportedOperationException();*/ }
}
