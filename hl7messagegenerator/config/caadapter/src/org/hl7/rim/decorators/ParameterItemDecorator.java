...
import org.hl7.rim.decorators.ParameterDecorator;
...
public abstract class ParameterItemDecorator extends ParameterDecorator implements ParameterItem {
  ...
  */
  public ST getSemanticsText() { return STnull.NA; }
  /** Property mutator, does nothing if not overloaded.semanticsText.
      @see org.hl7.rim.ParameterItem#setSemanticsText
  */
  public void setSemanticsText(ST semanticsText) { /*throw new UnsupportedOperationException();*/ }
}
