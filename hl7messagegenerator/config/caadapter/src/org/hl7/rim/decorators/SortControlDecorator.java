...
public abstract class SortControlDecorator extends InfrastructureRootDecorator implements SortControl {
  ...
  */
  public CS getDirectionCode() { return CSnull.NA; }
  /** Property mutator, does nothing if not overloaded.directionCode.
      @see org.hl7.rim.SortControl#setDirectionCode
  */
  public void setDirectionCode(CS directionCode) { /*throw new UnsupportedOperationException();*/ }
  /** Property accessor, returns null if not overloaded.querySpec.
      @see org.hl7.rim.SortControl#getQuerySpec
  */
  public QuerySpec getQuerySpec() { return null; }
  /** Property mutator, does nothing if not overloaded.querySpec.
      @see org.hl7.rim.SortControl#setQuerySpec
  */
  public void setQuerySpec(QuerySpec querySpec) { /* throw new UnsupportedOperationException(); */ }
}
