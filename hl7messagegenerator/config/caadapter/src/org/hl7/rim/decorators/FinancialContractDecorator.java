...
public abstract class FinancialContractDecorator extends ActDecorator implements FinancialContract {
  ...
  */
  public CE getPaymentTermsCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.paymentTermsCode.
      @see org.hl7.rim.FinancialContract#setPaymentTermsCode
  */
  public void setPaymentTermsCode(CE paymentTermsCode) { /*throw new UnsupportedOperationException();*/ }
}
