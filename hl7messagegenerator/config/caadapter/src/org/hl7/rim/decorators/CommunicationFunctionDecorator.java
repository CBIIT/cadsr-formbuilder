...
public abstract class CommunicationFunctionDecorator extends InfrastructureRootDecorator implements CommunicationFunction {
  ...
  */
  public TEL getTelecom() { return TELnull.NA; }
  /** Property mutator, does nothing if not overloaded.telecom.
      @see org.hl7.rim.CommunicationFunction#setTelecom
  */
  public void setTelecom(TEL telecom) { /*throw new UnsupportedOperationException();*/ }
  /** Property accessor, returns an empty collection if not overloaded.entity.
      @see org.hl7.rim.CommunicationFunction#getEntity
  */
  public /*AssociationSet*/List<Entity> getEntity() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.entity.
      @see org.hl7.rim.CommunicationFunction#setEntity
  */
  public void setEntity(/*AssociationSet*/List<Entity> entity) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded entity.
      @see org.hl7.rim.CommunicationFunction#setEntity
  */
  public void addEntity(Entity entity) { throw new UnsupportedOperationException(); }
  ...
  */
  public /*AssociationSet*/List<Transmission> getTransmission() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.transmission.
      @see org.hl7.rim.CommunicationFunction#setTransmission
  */
  public void setTransmission(/*AssociationSet*/List<Transmission> transmission) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded transmission.
      @see org.hl7.rim.CommunicationFunction#setTransmission
  */
  public void addTransmission(Transmission transmission) { throw new UnsupportedOperationException(); }
}
