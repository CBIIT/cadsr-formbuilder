...
public abstract class PatientDecorator extends RoleDecorator implements Patient {
  ...
  */
  public CE getVeryImportantPersonCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.veryImportantPersonCode.
      @see org.hl7.rim.Patient#setVeryImportantPersonCode
  */
  public void setVeryImportantPersonCode(CE veryImportantPersonCode) { /*throw new UnsupportedOperationException();*/ }
}
