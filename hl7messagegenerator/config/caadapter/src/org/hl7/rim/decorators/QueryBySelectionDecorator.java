...
public abstract class QueryBySelectionDecorator extends QuerySpecDecorator implements QueryBySelection {
  ...
  */
  public /*AssociationSet*/List<SelectionExpression> getSelectionExpression() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.selectionExpression.
      @see org.hl7.rim.QueryBySelection#setSelectionExpression
  */
  public void setSelectionExpression(/*AssociationSet*/List<SelectionExpression> selectionExpression) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded selectionExpression.
      @see org.hl7.rim.QueryBySelection#setSelectionExpression
  */
  public void addSelectionExpression(SelectionExpression selectionExpression) { throw new UnsupportedOperationException(); }
}
