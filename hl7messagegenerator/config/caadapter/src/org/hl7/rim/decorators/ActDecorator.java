...
/** Implementation of org.hl7.rim.Act as an abstract decorator, i.e., a class that returns NULL/NA or nothing for all property accessprs amd that raises UnsupportedOperationExceptions for all mutators. This is used to adapt custom application classes to the RIM class interfaces and only bother about mapping those properties that actually apply to the application class. This can be done in one of two ways: (1) the client class can extend the decorator directly, and implement the applicable properties, or (2) the abstract decorator can be extend to a concrete decorator, which would hold a reference to the client object and method bodies to delegate and adapt the applicable properties.
 @see org.hl7.rim.Act
  */
public abstract class ActDecorator extends InfrastructureRootDecorator implements Act {
  /** Property accessor, returns NULL/NA if not overloaded.classCode.
      @see org.hl7.rim.Act#getClassCode
  */
  public CS getClassCode() { return CSnull.NA; }
  ...
  */
  public CS getMoodCode() { return CSnull.NA; }
  /** Property mutator, does nothing if not overloaded.moodCode.
      @see org.hl7.rim.Act#setMoodCode
  */
  public void setMoodCode(CS moodCode) { /*throw new UnsupportedOperationException();*/ }
  /** Property accessor, returns NULL/NA if not overloaded.id.
      @see org.hl7.rim.Act#getId
  */
  public SET<II> getId() { return SETnull.NA; }
  ...
  */
  public CD getCode() { return CDnull.NA; }
  ...
  */
  public ST getDerivationExpr() { return STnull.NA; }
  ...
  */
  public ED getTitle() { return EDnull.NA; }
  ...
  */
  public ED getText() { return EDnull.NA; }
  ...
  */
  public CS getStatusCode() { return CSnull.NA; }
  ...
  */
  public SET<TS> getEffectiveTime() { return SETnull.NA; }
  ...
  */
  public SET<TS> getActivityTime() { return SETnull.NA; }
  ...
  */
  public TS getAvailabilityTime() { return TSnull.NA; }
  ...
  */
  public SET<CE> getPriorityCode() { return SETnull.NA; }
  ...
  */
  public SET<CE> getConfidentialityCode() { return SETnull.NA; }
  ...
  */
  public IVL<INT> getRepeatNumber() { return IVLnull.NA; }
  ...
  */
  public BL getInterruptibleInd() { return BLimpl.NA; }
  ...
  */
  public CE getLevelCode() { return CEnull.NA; }
  ...
  */
  public BL getIndependentInd() { return BLimpl.NA; }
  ...
  */
  public CE getUncertaintyCode() { return CEnull.NA; }
  ...
  */
  public SET<CE> getReasonCode() { return SETnull.NA; }
  ...
  */
  public CE getLanguageCode() { return CEnull.NA; }
  ...
  */
  public /*AssociationSet*/List<ActRelationship> getOutboundRelationship() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.outboundRelationship.
      @see org.hl7.rim.Act#setOutboundRelationship
  */
  public void setOutboundRelationship(/*AssociationSet*/List<ActRelationship> outboundRelationship) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded outboundRelationship.
      @see org.hl7.rim.Act#setOutboundRelationship
  */
  public void addOutboundRelationship(ActRelationship outboundRelationship) { throw new UnsupportedOperationException(); }
  ...
  */
  public /*AssociationSet*/List<ActRelationship> getInboundRelationship() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.inboundRelationship.
      @see org.hl7.rim.Act#setInboundRelationship
  */
  public void setInboundRelationship(/*AssociationSet*/List<ActRelationship> inboundRelationship) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded inboundRelationship.
      @see org.hl7.rim.Act#setInboundRelationship
  */
  public void addInboundRelationship(ActRelationship inboundRelationship) { throw new UnsupportedOperationException(); }
  /** Property accessor, returns an empty collection if not overloaded.participation.
      @see org.hl7.rim.Act#getParticipation
  */
  public /*AssociationSet*/List<Participation> getParticipation() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.participation.
      @see org.hl7.rim.Act#setParticipation
  */
  public void setParticipation(/*AssociationSet*/List<Participation> participation) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded participation.
      @see org.hl7.rim.Act#setParticipation
  */
  public void addParticipation(Participation participation) { throw new UnsupportedOperationException(); }
}
