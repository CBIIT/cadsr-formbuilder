...
public abstract class DiagnosticImageDecorator extends ObservationDecorator implements DiagnosticImage {
  ...
  */
  public CE getSubjectOrientationCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.subjectOrientationCode.
      @see org.hl7.rim.DiagnosticImage#setSubjectOrientationCode
  */
  public void setSubjectOrientationCode(CE subjectOrientationCode) { /*throw new UnsupportedOperationException();*/ }
}
