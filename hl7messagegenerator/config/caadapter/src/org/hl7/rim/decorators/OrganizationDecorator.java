...
public abstract class OrganizationDecorator extends EntityDecorator implements Organization {
  ...
  */
  public CE getStandardIndustryClassCode() { return CEnull.NA; }
  /** Property mutator, does nothing if not overloaded.standardIndustryClassCode.
      @see org.hl7.rim.Organization#setStandardIndustryClassCode
  */
  public void setStandardIndustryClassCode(CE standardIndustryClassCode) { /*throw new UnsupportedOperationException();*/ }
}
