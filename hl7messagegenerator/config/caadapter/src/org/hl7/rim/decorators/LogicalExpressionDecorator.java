...
public abstract class LogicalExpressionDecorator extends SelectionExpressionDecorator implements LogicalExpression {
  ...
  */
  public CS getRelationalConjunctionCode() { return CSnull.NA; }
  /** Property mutator, does nothing if not overloaded.relationalConjunctionCode.
      @see org.hl7.rim.LogicalExpression#setRelationalConjunctionCode
  */
  public void setRelationalConjunctionCode(CS relationalConjunctionCode) { /*throw new UnsupportedOperationException();*/ }
  ...
  */
  public /*AssociationSet*/List<SelectionExpression> getUserAsLeft() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.userAsLeft.
      @see org.hl7.rim.LogicalExpression#setUserAsLeft
  */
  public void setUserAsLeft(/*AssociationSet*/List<SelectionExpression> userAsLeft) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded userAsLeft.
      @see org.hl7.rim.LogicalExpression#setUserAsLeft
  */
  public void addUserAsLeft(SelectionExpression userAsLeft) { throw new UnsupportedOperationException(); }
  ...
  */
  public /*AssociationSet*/List<SelectionExpression> getUserAsRight() { return Collections.EMPTY_LIST; }
  /** Property mutator, does nothing if not overloaded.userAsRight.
      @see org.hl7.rim.LogicalExpression#setUserAsRight
  */
  public void setUserAsRight(/*AssociationSet*/List<SelectionExpression> userAsRight) { /* throw new UnsupportedOperationException(); */ }
  /** Association adder, throws UnsupportedOperationException if not overloaded userAsRight.
      @see org.hl7.rim.LogicalExpression#setUserAsRight
  */
  public void addUserAsRight(SelectionExpression userAsRight) { throw new UnsupportedOperationException(); }
}
