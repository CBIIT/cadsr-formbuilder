...
public enum RoleLinkType implements CS {
  ...
  /** This relationship indicates the source Role is available to the target Role as a backup.<p>
   <emph role="strong">Open Issue:</emph> PM TC needs to add an example that includes the notion of "covers for", "supports," "delegates." Need to consider additional
   concepts and a more precise definition.
</p> */
  IsBackupFor(null, null, "BACKUP", "is backup for"),
  /** The source Role has direct authority over the target role in a chain of authority. */
  HasDirectAuthorityOver(null, null, "DIRAUTH", "has direct authority over"),
  /** The source Role has indirect authority over the target role in a chain of authority. */
  HasIndirectAuthorityOver(null, null, "INDAUTH", "has indirect authority over"),
  /** The target Role is part of the Source Role. */
  HasPart(null, null, "PART", "has part"),
...
new effective time for a registry entry or a certification, etc. */
  Replaces(null, null, "REPL", "replaces");
