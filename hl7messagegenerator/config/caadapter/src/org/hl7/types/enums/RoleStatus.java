...
/** Codes representing the defined possible states of an Role, as defined by the Role class state machine.This table controls
...
public enum RoleStatus implements CS {
  ...
  Pending(Normal, null, "pending", "pending"),
