...
some, any one, or a specific thing.This table controls values for structural elements of the HL7 Reference Information Model.
...
of a thing. For example, QUANTIFIED_KIND of syringe (quantity = 3,) stands for exactly three syringes. */
  DescribedQuantified(Determined, null, "QUANTIFIED_KIND", "described quantified"),
...
(quantity = 1,) stands for exactly one human being. */
  Specific(null, null, "INSTANCE", "specific");
