...
public enum ActPriority implements CS {
  ...
  CallbackPlacerForScheduling(Callback, null, "CSP", "callback placer for scheduling"),
  ...
  ContactRecipientForScheduling(Callback, null, "CSR", "contact recipient for scheduling"),
  /** As soon as possible, next highest priority after stat. */
  ASAP(null, null, "A", "ASAP"),
  /** Filler should contact the placer as soon as results are available, even for preliminary results. (Was "C" in HL7 verion 2.3's
reporting priority.) */
  CallbackResults(null, null, "CR", "callback results"),
  /**  */
  Elective(null, null, "EL", "elective"),
  /**  */
  Emergency(null, null, "EM", "emergency"),
