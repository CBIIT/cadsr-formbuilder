...
ActRelationship.contextControlCode, ActRelationship.contextConductionInd).This table controls values for structural elements
of the HL7 Reference Information Model. Therefore, it is part of the Normative Ballot for the RIM. */
...
context to be propagated. */
  Additive_NonPropagating(Additive, NonPropagating, null, "AN", "additive, non-propagating"),
...
whatsoever will propagate to any child Acts that allow context to be propagated. */
  Overriding_NonPropagating(NonPropagating, Overriding, null, "ON", "overriding, non-propagating"),
...
itself propagate with the other authors to any child Acts that allow context to be propagated. */
  Additive_Propagating(Additive, Propagating, null, "AP", "additive, propagating"),
  /** The association is added to the existing context associated with the Act, but overrides an association with the same or more
...
author to propagate to any child Acts that allow context to be propagated. */
  Overriding_Propagating(Overriding, Propagating, null, "OP", "overriding, propagating");
