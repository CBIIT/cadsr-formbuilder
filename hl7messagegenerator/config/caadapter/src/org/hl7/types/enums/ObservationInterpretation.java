...
if the instrument is inadequate). If an off-scale value is also low or critically low one must also report L and LL respectively. */
  LowOffScale(Exceptions, null, "<", "low off scale"),
...
HH respectively. */
  HighOffScale(Exceptions, null, ">", "high off scale"),
  ...
  HighAlert(NormalityAlert, NormalityHigh, null, "HH", "High alert"),
  ...
  LowAlert(NormalityAlert, NormalityLow, null, "LL", "Low alert"),
  /** Normal (for all service types) */
  Normal(Normality, null, "N", "Normal"),
  ...
  /** Intermediate */
  Intermediate(Susceptibility, null, "I", "intermediate"),
  /** Moderately susceptible */
  ModeratelySusceptible(Susceptibility, null, "MS", "moderately susceptible"),
  /** Resistent */
  Resistent(Susceptibility, null, "R", "resistent"),
  /** Susceptible */
  Susceptible(Susceptibility, null, "S", "susceptible"),
  /** Very susceptible */
  VerySusceptible(Susceptibility, null, "VS", "very susceptible");
