...
/** Codes representing the defined possible states of an Act, as defined by the Act class state machine.This table controls values
for structural elements of the HL7 Reference Information Model. Therefore, it is part of the Normative Ballot for the RIM. */
...
for the life-cycle. */
  ...
  /** The Act has been terminated prior to the originally indended completion */
  Aborted(Normal, null, "aborted", "aborted"),
...
action should be taken against it until it is released */
  Suspended(Normal, null, "suspended", "suspended"),
...
for audit purposes only. */
  ...
  Obsolete(null, null, "obsolete", "obsolete");
