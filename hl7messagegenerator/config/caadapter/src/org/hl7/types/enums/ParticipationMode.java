...
/** A set of codes specifying the modality by which the Entity playing the Role is participating in the Act.<p>
   <emph>Examples:</emph> Physically present, over the telephone, written communication. 
</p>
<p>
   <emph>Rationale:</emph> Particularly for author (originator) participants this is used to specify whether the information represented by the act
...
public enum ParticipationMode implements CS {
  ...
  Telephone(Verbal, null, "PHONE", "telephone"),
...
an electronic medium */
  Videoconferencing(Verbal, null, "VIDEOCONF", "videoconferencing"),
...
typesetter, computer or similar mechanism. */
  Typewritten(Written, null, "TYPEWRIT", "typewritten"),
  ...
  PhysicalPresence(null, null, "PHYSICAL", "physical presence"),
...
by electronic or mechanical means. (The participation involves more than communication.) */
  RemotePresence(null, null, "REMOTE", "remote presence");
