...
access (cf. to actor type code). */
  Individual(ByAccessKind, null, "I", "individual"),
...
medical or business need may access this item. */
  ...
  SubstanceAbuseRelated(ByInfoType, null, "ETH", "substance abuse related"),
  /** HIV and AIDS related item */
  HIVRelated(ByInfoType, null, "HIV", "HIV related"),
  /** Psychiatry related item */
  PsychiatryRelate(ByInfoType, null, "PSY", "psychiatry relate"),
  /** Sexual assault / domestic violence related item */
  SexualAndDomesticViolenceRelated(ByInfoType, null, "SDV", "sexual and domestic violence related"),
  ...
  Celebrity(Modifiers, null, "C", "celebrity"),
...
request. */
  Sensitive(Modifiers, null, "S", "sensitive"),
