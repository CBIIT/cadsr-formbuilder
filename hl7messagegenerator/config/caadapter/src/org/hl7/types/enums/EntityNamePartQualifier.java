...
public enum EntityNamePartQualifier implements CS {
  ...
  LegalStatus(OrganizationNamePartQualifier, null, "LS", "Legal status"),
  /**  */
  ...
  Academic(PersonNamePartAffixTypes, null, "AC", "academic"),
...
track of this. */
  Nobility(PersonNamePartAffixTypes, null, "NB", "nobility"),
...
their credential suffices. */
  Professional(PersonNamePartAffixTypes, null, "PR", "professional"),
...
prefixes exist in other languages such as Spanish, French or Portugese. */
  Voorvoegsel(PersonNamePartAffixTypes, null, "VV", "voorvoegsel"),
  /**  */
  ...
  Adopted(PersonNamePartChangeQualifier, null, "AD", "adopted"),
...
may have changed later. */
  Birth(PersonNamePartChangeQualifier, null, "BR", "birth"),
...
inference about gender can be made from the existence of spouse names. */
  Spouse(PersonNamePartChangeQualifier, null, "SP", "spouse"),
  /**  */
  ...
  Callme(PersonNamePartMiscQualifier, null, "CL", "callme"),
...
scripts. Initials may consist of more than one letter, e.g., "Ph." could stand for "Philippe" or "Th." for "Thomas". */
  Initial(PersonNamePartQualifier, null, "IN", "initial");
