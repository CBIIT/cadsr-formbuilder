...
of high-level categories (such as represented by the Entity subclasses). Each of these terms must be harmonized and is specializable.
The value sets beneath are drawn from multiple, frequently external, domains that reflect much more fine-grained typing.This
table controls values for structural elements of the HL7 Reference Information Model. Therefore, it is part of the Normative
Ballot for the RIM. */
...
a living subject). */
  ...
  Animal(NonPersonLivingSubject, null, "ANM", "animal"),
  /** All single celled living organisms including protozoa, bacteria, yeast, viruses, etc. */
  Microorganism(NonPersonLivingSubject, null, "MIC", "microorganism"),
  /** A living subject from the order of plants. */
  Plant(NonPersonLivingSubject, null, "PLNT", "plant"),
  /** A living subject of the species homo sapiens. */
  Person(LivingSubject, null, "PSN", "person"),
  ...
  Holder(Container, null, "HOLD", "holder"),
...
of device is identified by the code attribute inherited from Entity.<p>
  ...
  CertificateRepresentation(Device, null, "CER", "certificate representation"),
  /** Class to contain unique attributes of diagnostic imaging equipment. */
  ImagingModality(Device, null, "MODDV", "imaging modality"),
...
agencies, associations. */
  PublicInstitution(Organization, null, "PUB", "public institution"),
  /** A physical place or site with its containing structure. May be natural or man-made. The geographic position of a place may
or may not be constant. */
  Place(Root, "EntityClassPlace", "PLC", "place"),
  /** The territory of a city, town or other municipality. */
  CityOrTown(Place, null, "CITY", "city or town"),
  /** The territory of a sovereign nation. */
  Country(Place, null, "COUNTRY", "country"),
  /** The territory of a county, parish or other division of a state or province. */
  CountyOrParish(Place, null, "COUNTY", "county or parish"),
  /** The territory of a state, province, department or other division of a sovereign country. */
  StateOrProvince(Place, null, "PROVINCE", "state or province"),
  /** A health chart included to serve as a document receiving entity in the management of medical records. */
  HealthChartEntity(Root, null, "HCE", "health chart entity"),
