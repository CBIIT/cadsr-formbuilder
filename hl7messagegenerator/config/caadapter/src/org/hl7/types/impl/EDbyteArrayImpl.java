...
public final class EDbyteArrayImpl extends BINbyteArrayImpl implements ED {
  ...
  private EDbyteArrayImpl(byte[] bits, long offset, long length,
    CS mediaType, CS charSet, CS language, CS compression, TEL reference,
  ...
  public static ED valueOf(byte[] bits, long offset, long length,
    String mediaTypeString, String charSetString, String languageString,
    String compressionString, TEL reference,
    BIN integrityCheck, String integrityCheckAlgorithmString, ED thumbnail) {
    ...
    return new EDbyteArrayImpl(bits, offset, length, mediaType, charSet,
      language, compression, reference, integrityCheck,
      integrityCheckAlgorithm, thumbnail);
  }

  public static ED valueOf(byte[] bits, long offset, long length) {
    
    return valueOf(bits, offset, length, null, null, null, null,
      TELnull.NI, BINnull.NI, null, EDnull.NI);
  }
