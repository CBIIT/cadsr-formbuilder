...
/** Minimal implementation of CE as a model we can use for all other
...
public final class CEnull extends ANYimpl implements CE {
  ...
  private CEnull(NullFlavor nf) {
    super(nf);
  }

  /** Get the a null value according to the null flavor code.
   */
  public static CEnull valueOf(String nullFlavorString) {
