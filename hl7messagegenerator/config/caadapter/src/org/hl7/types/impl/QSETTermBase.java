...
public abstract class QSETTermBase<T extends QTY> 
  extends ANYimpl implements QSET<T>
{
  ...
  public QSET<T> except(T element) {
    return QSETDifferenceImpl.valueOf(this, 
		   QSETSingularityImpl.valueOf(element));
  }
  ...
  public QSET<T> except(QSET<T> otherset) {
    ...
    public QSET<T> periodicHull(SET<T> otherset) {
	if(otherset instanceof QSET)
