...
public class RTOnull extends ANYimpl implements RTO {
  public static RTOnull NI   = new RTOnull(NullFlavorImpl.NI);
  public static RTOnull NA   = new RTOnull(NullFlavorImpl.NA);
  public static RTOnull UNK  = new RTOnull(NullFlavorImpl.UNK);
  public static RTOnull NASK = new RTOnull(NullFlavorImpl.NASK);
  public static RTOnull ASKU = new RTOnull(NullFlavorImpl.ASKU);
  public static RTOnull NAV  = new RTOnull(NullFlavorImpl.NAV);
  public static RTOnull OTH  = new RTOnull(NullFlavorImpl.OTH);
  public static RTOnull PINF = new RTOnull(NullFlavorImpl.PINF);
  public static RTOnull NINF = new RTOnull(NullFlavorImpl.NINF);

  private RTOnull(NullFlavor nf) {
    super(nf);
  }

  /** Get the a null value according to the null flavor code.
   */
  public static RTOnull valueOf(String nullFlavorString) {
