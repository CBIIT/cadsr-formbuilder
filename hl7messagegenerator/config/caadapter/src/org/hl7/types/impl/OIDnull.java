...
public final class OIDnull extends ANYimpl implements OID {
  public static OIDnull NI   = new OIDnull(NullFlavorImpl.NI);
  public static OIDnull NA   = new OIDnull(NullFlavorImpl.NA);
  public static OIDnull UNK  = new OIDnull(NullFlavorImpl.UNK);
  public static OIDnull NASK = new OIDnull(NullFlavorImpl.NASK);
  public static OIDnull ASKU = new OIDnull(NullFlavorImpl.ASKU);
  public static OIDnull NAV  = new OIDnull(NullFlavorImpl.NAV);
  public static OIDnull OTH  = new OIDnull(NullFlavorImpl.OTH);
  public static OIDnull PINF = new OIDnull(NullFlavorImpl.PINF);
  public static OIDnull NINF = new OIDnull(NullFlavorImpl.NINF);

  private OIDnull(NullFlavor nf) {
    super(nf);
  }

  /** Get the a null value according to the null flavor code.
   */
  public static OIDnull valueOf(String nullFlavorString) {
