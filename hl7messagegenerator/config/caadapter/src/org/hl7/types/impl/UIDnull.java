...
/** Minimal implementation of UID as a model we can use for all other
...
public final class UIDnull extends ANYimpl implements UID {
  public static UIDnull NI   = new UIDnull(NullFlavorImpl.NI);
  public static UIDnull NA   = new UIDnull(NullFlavorImpl.NA);
  public static UIDnull UNK  = new UIDnull(NullFlavorImpl.UNK);
  public static UIDnull NASK = new UIDnull(NullFlavorImpl.NASK);
  public static UIDnull ASKU = new UIDnull(NullFlavorImpl.ASKU);
  public static UIDnull NAV  = new UIDnull(NullFlavorImpl.NAV);
  public static UIDnull OTH  = new UIDnull(NullFlavorImpl.OTH);
  public static UIDnull PINF = new UIDnull(NullFlavorImpl.PINF);
  public static UIDnull NINF = new UIDnull(NullFlavorImpl.NINF);

  private UIDnull(NullFlavor nf) {
    super(nf);
  }

  /** Get the a null value according to the null flavor code.
   */
  public static UIDnull valueOf(String nullFlavorString) {
