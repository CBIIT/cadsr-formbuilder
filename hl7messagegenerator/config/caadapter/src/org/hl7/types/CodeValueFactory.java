...
public abstract class CodeValueFactory {
  ...
  public static class Exception extends java.lang.RuntimeException {
    ...
    public Exception(Throwable nested) { super(nested); }
    public Exception(String message, Throwable nested) { super(message, nested); }
  }
  ...
  public static class UnknownCodeSystemException extends CodeValueFactory.Exception {
    ...
    public UnknownCodeSystemException(String message) { super(message); }
    public UnknownCodeSystemException(Throwable nested) { super(nested); }
    public UnknownCodeSystemException(String message, Throwable nested) { super(message, nested); }
  }
  ...
  public static class InvalidCodeException extends CodeValueFactory.Exception {
    ...
    public InvalidCodeException(Throwable nested) { super(nested); }
    public InvalidCodeException(String message, Throwable nested) { super(message, nested); }
  }
  ...
  public static class DelegateException extends CodeValueFactory.Exception {
    ...
    public DelegateException(String message) { super(message); }
    public DelegateException(Throwable nested) { super(nested); }
    public DelegateException(String message, Throwable nested) { super(message, nested); }
  }
  ...
  public static class ConfigurationException extends CodeValueFactory.Exception {
    ...
    public ConfigurationException(Throwable nested) { super(nested); }
    public ConfigurationException(String message, Throwable nested) { super(message, nested); }
  }
}
