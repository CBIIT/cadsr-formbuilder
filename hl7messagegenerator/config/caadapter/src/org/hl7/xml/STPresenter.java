 ...
 *
 * <p>ST exists in 2 forms the ST full element type (where ST is the
 * text data) and the st type (where ST is usually some attribute
 * data.) In the case of ST as attribute value, the data types
 * containing such st attributes will usually allow just
 * java.lang.String in their factories. So, this is for the
 * full blown ST.</p>
 */
public class STPresenter extends DatatypePresenterBase {
  ...
  private final ContentHandler contentHandler_ = new STContentHandler();

  //------------------------------------------------------------------------
  private static class STContentHandler extends SimpleTypeContentHandler {
    //.......................................................................
    ST _result = null;
    /** This holds the potentially multiple characters events that
     we might get from the XML reader. */
    // this maybe should be in STPresenter
    private StringBuffer _stringBuffer = null;
    private String _languageString = null;
    ...
    protected void notifyActivation(Attributes atts) {
      ...
      if (nullFlavorString != null) {
        ...
        _languageString = atts.getValue(ATTR_LANGUAGE);
        _result = null;
      }
    }
    ...
    protected Object getResult() {
      if (_result == null) {
        if (_stringBuffer != null) {
          _result = ValueFactory.getInstance().STvalueOf(
              _stringBuffer.toString(), _languageString);  
          _stringBuffer = null;
          _languageString = null;
          return _result;
        } else {
  ...
  //--------------------------------------------------------------------------------------
  private static class STBuilder extends DatatypeBuilderImpl
  {
      ...
      ANY value, String localName) throws BuilderException
    {
      ...
      try
      {
        ...
        builder.addAttribute(ATTR_LANGUAGE, stValue.language());
  ...
  public static STPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new STBuilder(); }
}
