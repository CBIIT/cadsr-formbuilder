...
public class DatatypePresenterPropertiesBasedFactory
  extends DatatypePresenterFactory
{
  //-------------------------------------------------------------------------
  protected static final Logger LOGGER =
    Logger.getLogger("org.hl7.xml");

  //-------------------------------------------------------------------------
  private Properties props_ = new Properties();
  private HashMap<String, DatatypePresenter> presenterCache_ =
    new HashMap<String, DatatypePresenter>();
  ...
  public DatatypePresenterPropertiesBasedFactory() throws FactoryException
  {
    ...
    {
      throw new FactoryException("Factory " +
        "DatatypePresenterPropertiesBasedFactory cannot be created", ex);
    }
    finally
    {
  ...
  private String getClassName(String name) throws FactoryException
  {
    ...
    if (parameterStart<0) parameterStart=name.indexOf("_");
    if (parameterStart >= 0)
    {
  ...
  //-------------------------------------------------------------------------
  public DatatypePresenter createPresenter(String name)
    throws FactoryException
  {
    ...
    synchronized (presenterCache_)
    {
      ...
      if (presenter == null)
      {
        ...
        {
          String message = "Data type presenter " + name +
            " cannot be created";
