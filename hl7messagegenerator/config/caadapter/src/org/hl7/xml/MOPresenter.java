...
public class MOPresenter extends DatatypePresenterBase
{
  ...
  private final ContentHandler contentHandler_ = new MOContentHandler();
  ...
  private static class MOContentHandler extends SimpleTypeContentHandler
  {
    ...
    protected void notifyActivation(Attributes atts)
    {
      ...
      else
      {
        ...
        _result = MOimpl.valueOf(ValueFactory.getInstance()
          .REALvalueOfLiteral(valueString),
        CSimpl.valueOf(currencyString, "unknown"));
      }
    }
  ...
  //-------------------------------------------------------------------------
  private static class MOBuilder extends DatatypeBuilderImpl
  {
  ...
  //-------------------------------------------------------
  private MOPresenter() {}
  public static MOPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new MOBuilder(); }
}
