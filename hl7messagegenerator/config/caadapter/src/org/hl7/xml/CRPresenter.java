...
public class CRPresenter extends DatatypePresenterBase
{
  ...
  protected static class CRContentHandler extends TreeContentHandler {
    //.......................................................................
    public CRContentHandler(String namespaceURI, String localName,
    ...
    //.......................................................................
    protected CR valueOf(TreeContentHandler.Element element)
      throws SAXException {
      ...
      try {
        ...
        if (it.hasNext()) {
          ...
          CVPresenter.CVContentHandler newContext =
            (CVPresenter.CVContentHandler)cv.getHandler(el.getNamespaceURI(),
        ...
        return (invertedString != null) ?
          CRimpl.valueOf(name, value, invertedBool) :
            CRimpl.valueOf(name, value);
      }
  ...
  //-------------------------------------------------------------------------
  private static class CRBuilder extends DatatypeBuilderImpl
  {
  ...
  //---------------------------------------------------------------------------
  private CRPresenter() {}
  public static CRPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new CRBuilder(); }
}
