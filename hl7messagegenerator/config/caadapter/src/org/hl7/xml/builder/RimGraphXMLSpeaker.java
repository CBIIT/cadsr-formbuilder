...
@version $Id: RimGraphXMLSpeaker.java,v 1.1 2006-10-03 17:39:04 marwahah Exp $
*/
public class RimGraphXMLSpeaker extends XMLSpeaker {
  ...
  /** The ContentBuilder with more HL7 specific convenience
      methods added.
  */
  public class ContentBuilder extends XMLSpeaker.ContentBuilder {
    ...
    /** Check if the value is a null value and if so, put the nullFlavor
				attribute on the attributes list. Also creates the xsi:type attribute.
    ...
    */
    public boolean nullValueHandled(ANY value) throws SAXException {
			boolean __trace = false && value instanceof org.hl7.types.impl.PQnull;
    ...
    /** Check if the value is a null value and if so, put the nullFlavor
				...
				@param value the value checked
				@param localName the localName of the XML element
				@return true if value was null and attribute added otherwise false
    */
    ...
    @param localName the localName of the XML element
    */
    public void build(ANY value, String localName)
      throws SAXException
			{
				if (value == null) return;
  ...
  /** A specialization of the standard SAX InputSource that is
  ...
  */
  public static class InputSource extends org.xml.sax.InputSource {
    ...
    public InputSource(RimObject entryPoint,
    ...
    public RimObject getEntryPoint() { return _entryPoint;  }
    public void setCloneClass(CloneClass cloneClass) {
      _cloneClass = cloneClass;
    }
    public CloneClass getCloneClass() { return _cloneClass; }
  }
  ...
  */
  public static class DataValueInputSource extends org.xml.sax.InputSource {
    ...
    public Datatype getTypeConstraint() { return _typeConstraint; }
    private Datatype _typeConstraint=null;
    private ANY  _value = null;
    public void setValue(ANY value) { _value = value; }
    public ANY getValue() { return _value;  }

    private String _localName = null;
    public void setLocalName(String localName) { _localName = localName; }
  ...
  */
    ...
    throws IOException, SAXException
		{
			try {
				if(input instanceof RimGraphXMLSpeaker.InputSource) {
					...
					new MessageBuilderImpl(/* laxMode: */true).build(contentBuilder,
							oginput.getEntryPoint(),
							oginput.getCloneClass(),
							oginput.getCloneClass().getName());
  ...
  /** Parse from a URL. This URL could be a special scheme (e.g.
      like XPointer) that would denote an entryPoint and cloneClass,
 ...
 * HISTORY      : Revision 1.43  2006/06/11 22:17:24  echen
 * HISTORY      : Fix print out QSETnull error
 * HISTORY      :
 * HISTORY      : Revision 1.42  2006/06/11 03:26:44  echen
 * HISTORY      : Performer input text missing one attribute
 * HISTORY      :
 * HISTORY      : Revision 1.41  2006/06/10 23:34:43  echen
 * HISTORY      : Change RTO xml output from
 * HISTORY      :       <quantity xsi:type="RTO_INT_INT">
 * HISTORY      :          <numerator value="1"/>
 * HISTORY      :          <denominator value="100"/>
 * HISTORY      :       </quantity>
 * HISTORY      : to
 * HISTORY      :       <quantity>
