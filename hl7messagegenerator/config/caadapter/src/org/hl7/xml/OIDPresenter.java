...
public class OIDPresenter extends DatatypePresenterBase {
  ...
  //--------------------------------------------------------------------------------------
  private static class OIDBuilder implements DatatypeBuilder
  {
  ...
  public static OIDPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new OIDBuilder(); }
}
