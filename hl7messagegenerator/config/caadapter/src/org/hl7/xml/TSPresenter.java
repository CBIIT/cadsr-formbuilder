...
/**
 * @author Eric Chen
 * @version $Id: TSPresenter.java,v 1.1 2006-10-03 17:39:04 marwahah Exp $
 */
...
public class TSPresenter extends DatatypePresenterBase {
  ...
  private final ContentHandler contentHandler_ = new TSContentHandler();
  ...
  //------------------------------------------------------------------------
  private static class TSBuilder extends DatatypeBuilderImpl
  {
	...
	// builder.setShouldSetXsiType(false);
        if (builder.nullValueHandled(ts, localName)) return;
  ...
  //-------------------------------------------------------------------------
  private TSPresenter() {}
  public static TSPresenter instance() { return INSTANCE; }

  public static TS getValue(Object value) {
    if (value == null) return TSnull.NI;
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new TSBuilder(); }
}

/**
 * HISTORY      : $Log: not supported by cvs2svn $
 * HISTORY      : Revision 1.15  2005/09/08 20:33:53  gschadow
 * HISTORY      : this should address the outstanding SXCM awkwardness
 * HISTORY      :
 * HISTORY      : Revision 1.14  2005/09/08 19:37:06  echen
 * HISTORY      : Saved point
 * HISTORY      :
 */
