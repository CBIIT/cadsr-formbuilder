...
public class ANYPresenter extends DatatypePresenterBase {
  ...
  private static class ANYBuilder extends DatatypeBuilderImpl
  {
  ...
  public static ANYPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new ANYBuilder(); }
}
