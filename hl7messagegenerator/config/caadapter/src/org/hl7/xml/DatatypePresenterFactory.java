...
public abstract class DatatypePresenterFactory
{
  ...
  private static final String FACTORY_ID =
    "org.hl7.xml.DatatypePresenterFactory";
   ...
   * org.hl7.xml.DatatypePresenterFactory in the current directory.</li>
   * <li>Uses Services API to look for factory class name in the file
   * <code>META-INF/services/org.hl7.xml.DatatypePresenterFactory</code>
   * in jars on the classpath.</li>
   * <li>If none of the above exist, uses default properties based factory.</li>
   * </nl>
   */
  public static DatatypePresenterFactory getInstance()
  ...
  public abstract DatatypePresenter createPresenter(String typeSpec)
    throws FactoryException;

  /** Get a presenter appropriate to render the value */
  public abstract DatatypePresenter createPresenter(ANY value)
    throws FactoryException;
}
