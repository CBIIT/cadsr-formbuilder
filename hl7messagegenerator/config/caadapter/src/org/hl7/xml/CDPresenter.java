...
public class CDPresenter extends DatatypePresenterBase
{
  ...
  protected static class CDContentHandler extends TreeContentHandler {
    //.......................................................................
    public CDContentHandler(String namespaceURI, String localName,
    ...
    //.......................................................................
    protected static CD valueOf(TreeContentHandler.Element element)
      throws SAXException {
      ...
      try {
        ...
        if (it.hasNext()) {
          ...
          // Should be optimized.
          EDPresenter.EDContentHandler newContext =
            (EDPresenter.EDContentHandler)ed.getHandler(
              el.getNamespaceURI(), el.getLocalName(), el.getQName(),
              el.getAttributes());
        ...
        if (it.hasNext()) {
          ...
          do {
            ...
            // Should be optimized.
            CRPresenter.CRContentHandler newContext =
              (CRPresenter.CRContentHandler)cr.getHandler(
            el.getNamespaceURI(), el.getLocalName(), el.getQName(),
            el.getAttributes());
        ...
        if (it.hasNext()) {
          ...
          do {
            ...
            // Should be optimized.
            CDPresenter.CDContentHandler newContext =
              (CDPresenter.CDContentHandler)cd.getHandler(
            el.getNamespaceURI(), el.getLocalName(), el.getQName(),
            el.getAttributes());
        ...
        if (codeSystem == null) codeSystem = "unknown";
        
        return CDimpl.valueOf(code, codeSystem, codeSystemName,
          codeSystemVersion, displayName, originalText, qualifierList,
          translationSet);
      }
  ...
  //-------------------------------------------------------------------------
  private static class CDBuilder extends DatatypeBuilderImpl
  {
  ...
  //-------------------------------------------------------------------------
  private CDPresenter() {}
  public static CDPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new CDBuilder(); }
}
