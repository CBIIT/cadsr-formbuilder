...
public class CEPresenter extends DatatypePresenterBase {
  ...
  protected static class CEContentHandler extends TreeContentHandler {
    //.......................................................................
    public CEContentHandler(String namespaceURI, String localName,
      ...
      try {
	    ...
	    /*
            PQRPresenter.PQRContentHandler newContext =
              (PQRPresenter.PQRContentHandler)pqr.getHandler(el.getNamespaceURI(),el.getLocalName(), el.getQName(), el.getAttributes());
            
            PQR translation = newContext.valueOf(el);
	    */
            CVPresenter.CVContentHandler newContext =
              (CVPresenter.CVContentHandler)cv.getHandler(el.getNamespaceURI(),el.getLocalName(), el.getQName(), el.getAttributes());
            
            CV translation = newContext.valueOf(el);
	...
	return CEimpl.valueOf(CVimpl.valueOf(code, codeSystem, originalText, displayName, codeSystemName, codeSystemVersion),
			      (SET<CV>)SETjuSetAdapter.valueOf(translationSet));
      }
  ...
  //-------------------------------------------------------------------------
  private static class CEBuilder extends DatatypeBuilderImpl {
  ...
  //----------------------------------------------------------------
  private CEPresenter() {}
  public static CEPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new CEBuilder(); }
}
