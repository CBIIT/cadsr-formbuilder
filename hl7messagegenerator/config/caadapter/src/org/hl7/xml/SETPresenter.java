...
public class SETPresenter extends DatatypePresenterBase {
  ...
  private final ContentHandler contentHandler_ = new SETContentHandler();
  ...
  private static class SETBuilder extends DatatypeBuilderImpl {
    public void build(RimGraphXMLSpeaker.ContentBuilder builder, ANY value, String localName) throws BuilderException {
      if (value.isNullJ()) return;
      if (((SET)value).isEmpty().isTrue()) return;
  ...
  public static SETPresenter instance() { return INSTANCE; }
  ...
  public DatatypeBuilder getBuilder() { return new SETBuilder(); }
}
