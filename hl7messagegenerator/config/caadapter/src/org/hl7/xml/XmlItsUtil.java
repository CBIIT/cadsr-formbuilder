...
public class XmlItsUtil
{
    ...
    private static final Set<String> XMLITS_EXTRA_ATTRIBUTES =
    ...
    public static Feature lookupMetadataByTag(CloneClass cloneClass, String tag)
    {
        ...
        LOGGER.fine("###resolving tag: " + tag + " in clone class " + cloneClass.getName());

        for (Iterator it = cloneClass.iterateChildren(); it.hasNext();)
        {
            Feature feature = (Feature) it.next();

            LOGGER.fine("###feature: " + feature.getName() + ":" + feature.getClass());

            if (feature instanceof Attribute)
            {
                if (tag.equals(feature.getName()))
                {
                    LOGGER.fine("###found attribute: " + feature);
            ...
            else if (feature instanceof Association)
            {
                ...
                else if (feature instanceof CmetAssociation)
                {
                    ...
                    {
                        LOGGER.fine("###found cmet: " + feature);
                ...
                { // normal Attribute
                    ...
                    {
                        LOGGER.fine("###found association: " + feature);
                        return (Association) feature;
                    }
                }
            }
