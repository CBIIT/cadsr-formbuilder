...
public class SCPresenter extends DatatypePresenterBase {
  ...
  private final ContentHandler contentHandler_ = new SCContentHandler();
  ...
  //--------------------------------------------------------------------------------------
  private static class SCBuilder extends DatatypeBuilderImpl
  {
  ...
  public static SCPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new SCBuilder(); }
}
