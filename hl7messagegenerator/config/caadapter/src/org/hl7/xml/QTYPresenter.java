...
public class QTYPresenter extends DatatypePresenterBase {
  ...
  //-------------------------------------------------------------------------
  protected static class QTYContentHandler extends DataTypeContentHandler
     ...
     * endElement:
     *
     * Must determine which Presenter should do the work.  All possible 
     * choices are: TS, INT, REAL, RTO, PQ, MO.
     ************************************************************************/
  ...
  //--------------------------------------------------------------------------
  private static class QTYBuilder extends DatatypeBuilderImpl {
  ...
  public static QTYPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new QTYBuilder(); }
}
