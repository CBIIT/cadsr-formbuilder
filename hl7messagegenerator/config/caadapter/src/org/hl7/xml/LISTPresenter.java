...
public class LISTPresenter extends DatatypePresenterBase
{
  ...
  private final ContentHandler contentHandler_ = new LISTContentHandler();
  ...
  //-------------------------------------------------------------------------
  private static class LISTBuilder extends DatatypeBuilderImpl
  {
  ...
  public static LISTPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new LISTBuilder(); }
}
