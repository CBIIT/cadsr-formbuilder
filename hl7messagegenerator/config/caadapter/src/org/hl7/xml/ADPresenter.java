...
public class ADPresenter extends DatatypePresenterBase
{
  ...
  {
    //.......................................................................
    public ADContentHandler(String namespaceURI, String localName,
    ...
    protected AD valueOf(TreeContentHandler.Element element)
    {
      ...
      SET<CS> use = CSPresenter.parseList(useValue, "PostalAddressUse"); // FIXME: code system wrong! Use ENUM!
  ...
  //-----------------------------------------------------------------
  private static class ADBuilder extends DatatypeBuilderImpl
  {
    //.......................................................................
    private final CSPresenter.CSBuilder csBuilder_ =
      (CSPresenter.CSBuilder)CSPresenter.instance().getBuilder();
    private final ADXPPresenter.ADXPBuilder adxpBuilder_ =
      (ADXPPresenter.ADXPBuilder)ADXPPresenter.instance().getBuilder();
  ...
  //-------------------------------------------------------------------------
  private ADPresenter() {}
  public static ADPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new ADBuilder(); }
}
