...
public class PQPresenter extends DatatypePresenterBase {
  ...
  protected static class PQContentHandler extends SimpleTypeContentHandler {
    ...
    public void startElement(String namespaceURI,
        ...
        if(ATTR_TRANSLATION.equals(localName)){
            try {
	      PQRPresenter.PQRContentHandler dch = (PQRPresenter.PQRContentHandler)DatatypePresenterFactory.getInstance().createPresenter("PQR").getContentHandler(namespaceURI, localName, qName, atts, _datatype);
          ...
          try {
            _result = PQimpl.valueOf(value, unit);
              ...
              LOGGER.log(Level.WARNING,
                  "Error with unit=\"" + unit + "\"", ex.getCause());
              _result  = PQnull.NI;
           }
        }
      }
        ...
        if (node instanceof TreeContentHandler.Element)
        {
          ...
          String unit = element.getAttributeValue(ATTR_UNIT);
            try {
                ...
                LOGGER.log(Level.WARNING,
                  "Error with data <unit=\"" + unit + "\"> because of " + ex.getMessage(), ex);
                return PQnull.NI;
            }
  ...
  //--------------------------------------------------------------------------
  private static class PQBuilder extends DatatypeBuilderImpl
  {
    public void build(RimGraphXMLSpeaker.ContentBuilder builder, ANY value, String localName) throws BuilderException
			{
              ...
              try {
								...
								DatatypePresenterFactory.getInstance()
									.createPresenter("SET")
									.getBuilder()
									.build(builder,s,ATTR_TRANSLATION);
    ...
    //.......................................................................
    public void buildStructural(RimGraphXMLSpeaker.ContentBuilder builder, ANY value, String localName) throws BuilderException {
  ...
  //--------------------------------------------------------------------------
  private PQPresenter() {}
  public static PQPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new PQBuilder(); }
}
