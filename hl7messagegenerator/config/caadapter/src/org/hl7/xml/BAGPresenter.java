...
public class BAGPresenter extends DatatypePresenterBase
{
  ...
  private final ContentHandler contentHandler_ = new BAGContentHandler();
  ...
  //-------------------------------------------------------------------------
  private static class BAGBuilder extends DatatypeBuilderImpl
  {
      ...
      String localName) throws BuilderException
    {
      ...
      {
        BAG bag = (BAG)value;
        for (Iterator<ANY> it = bag.iterator(); it.hasNext(); )
        {
          ANY component = it.next();
  ...
  public static BAGPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new BAGBuilder(); }
}
