...
public class PNPresenter extends ENPresenter
{
  ...
  protected static class PNContentHandler extends TreeContentHandler {
    //.......................................................................
    public PNContentHandler(String namespaceURI, String localName,
...
//    IVL<TS> validTime = it.hasNext() ? IVLPresenter.valueOf(it.next()) : null;
      ...
      for (Iterator<Node> it2 = element.getChildren().iterator(); it2.hasNext(); )
      {
        ...
        PNXP part = PNXPPresenter.PNXPContentHandler.valueOf(node);
  ...
  //-------------------------------------------------------------------------
  private static class PNBuilder extends DatatypeBuilderImpl
  {
    //.......................................................................
    private final CSPresenter.CSBuilder csBuilder_ =
      (CSPresenter.CSBuilder)CSPresenter.instance().getBuilder();
    private final PNXPPresenter.PNXPBuilder pnxpBuilder_ =
      (PNXPPresenter.PNXPBuilder)PNXPPresenter.instance().getBuilder();
      ...
      String localName) throws BuilderException
    {
      ...
      try
      {
        ...
        csBuilder_.buildAttribute(builder, pn.use(), ATTR_USE);
        
        builder.startElement(localName);
        
        for (Iterator<ENXP> it = pn.iterator(); it.hasNext(); )
        {
          PNXP pnxp = (PNXP)it.next();
          pnxpBuilder_.build(builder, pnxp);
        }
        
        // Emit validTime if present.
//        builder.build(pn.validTime(), ATTR_VALID_TIME);
    ...
    {
      throw new BuilderException("PN cannot be a structural attribute");
    }
  }

  //---------------------------------------------------------------------------
  private PNPresenter() {}
  public static PNPresenter instance() { return INSTANCE; }
  ...
  //-------------------------------------------------------------------------
  public DatatypeBuilder getBuilder() { return new PNBuilder(); }
}
