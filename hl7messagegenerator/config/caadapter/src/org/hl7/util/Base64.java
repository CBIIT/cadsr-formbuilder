...
public class Base64
   {
    ...
    protected static final Logger LOGGER = Logger.getLogger("org.hl7.util");
   ...
   public String encode(byte[] b)
      ...
      if ( outputLength != sb.length() )
         {
         LOGGER.warning("oops: minor program flaw: output length mis-estimated \n"
                        + "estimate:" + outputLength + "\n"
                        +  "actual:" + sb.length());
         }
      return sb.toString();
      }// end encode
   ...
   static  /* initialise valueToChar and charToValue tables */
   {
   ...
   public static void show (byte[] b)
      ...
      for ( int i=0; i<b.length; i++ )
         {
          LOGGER.info( Integer.toHexString(b[i] & 0xff) + " \n");
         }
      }
   ...
   public static void display (byte[] b)
      ...
      for ( int i=0; i<b.length; i++ )
         {
         LOGGER.info(new String((new char[]{(char)b[i]})) + "\n");
         }
      }
