...
public class StringUtils
{
  ...
  public static boolean matchesCmetHmdPattern(String s)
  {
     ...
     * @return File Name
     */
  public static String searchMessageTypeFileName(String fileDirectory, String messageType, String fileExtension)
        throws FileNotFoundException
  {
      for (int i = 1; i < 100; i++)
      {
          String pad = i < 10 ? "UV0" + i : "UV" + String.valueOf(i);
          File file = new File(fileDirectory + messageType + pad + "." + fileExtension);
          if (file.exists())
            return file.getAbsolutePath();
      }

      File file = new File(fileDirectory + messageType + "." + fileExtension);
      if (file.exists())
        return file.getAbsolutePath();
  ...
  public static String trimSuffix(String s, String suffix)
  {
    ...
    public static String forceInitialLowerCase(String s)
    {
