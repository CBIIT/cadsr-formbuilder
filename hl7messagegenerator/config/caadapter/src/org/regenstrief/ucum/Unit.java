...
/** This class implements a Unit as a dimensioned quantity that
 ...
 @version $Id: Unit.java,v 1.1 2006-10-03 17:39:05 marwahah Exp $
 */
			...
			if(seq.group(G_BPAREN) != null) {
				...
				if(operand == null)
					operand = new Unit(ValueFactory.getInstance().STvalueOfLiteral(symbol),	
														 ...
														 Dimension.ZERO, 
														 FL_FACTOR);
			} if(seq.group(G_UNIT_TOKEN) != null) {
				// mind the order of this, as it must occur after the test for
				// G_FACTOR.
				...
				if(operand == null && seq.group(G_SIMPLE_UNIT) != null) {
					...
					if(seq.group(G_EXPONENT) == null) 
						...
						operand 
						= new Unit(ValueFactory.getInstance().STvalueOfLiteral(symbol),
