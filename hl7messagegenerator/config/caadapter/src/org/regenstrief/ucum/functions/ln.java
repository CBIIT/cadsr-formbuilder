 ...
 *
 * $Id: ln.java,v 1.1 2006-10-03 17:39:05 marwahah Exp $
 */
...
public final class ln implements FunctionPair {    
    public REAL f_to  (REAL x) { return x.log(); }
    public REAL f_from(REAL x) { return x.exp(); }
}
