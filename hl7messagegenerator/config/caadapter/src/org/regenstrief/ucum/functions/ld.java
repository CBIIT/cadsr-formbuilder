 ...
 *
 * $Id: ld.java,v 1.1 2006-10-03 17:39:05 marwahah Exp $
 */
...
public final class ld implements FunctionPair {    
  static final REAL TWO = ValueFactory.getInstance()
    .REALvalueOfLiteral("2");

  static final REAL LN_TWO  = TWO.log();
  
  public REAL f_to  (REAL x) { 
    return x.log().dividedBy(LN_TWO); 
  }
