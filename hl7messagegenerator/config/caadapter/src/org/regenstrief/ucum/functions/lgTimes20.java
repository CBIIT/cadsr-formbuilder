 ...
 *
 * $Id: lgTimes20.java,v 1.1 2006-10-03 17:39:05 marwahah Exp $
 */
...
public final class lgTimes20 implements FunctionPair {    
  ...
  static final REAL TWENTY  = ValueFactory.getInstance()
    .REALvalueOfLiteral("20");
  
  public REAL f_to  (REAL x) { 
    return TWENTY.times(x.log().dividedBy(LN_TEN)); 
  }
  
  public REAL f_from(REAL x) { 
    return TEN.power(x.dividedBy(TWENTY)); 
  }
}
