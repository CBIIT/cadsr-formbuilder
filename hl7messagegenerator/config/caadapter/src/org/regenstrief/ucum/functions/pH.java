 ...
 *
 * $Id: pH.java,v 1.1 2006-10-03 17:39:05 marwahah Exp $
 */
...
public final class pH implements FunctionPair {   
 
  static final REAL TEN  = ValueFactory.getInstance()
    .REALvalueOfLiteral("10").log();

  static final REAL LN_TEN = TEN.log();

  public REAL f_to  (REAL x) { 
    return x.log().dividedBy(LN_TEN).negated(); 
  }

  public REAL f_from(REAL x) { 
    return TEN.power(x.negated()); 
  }
}
