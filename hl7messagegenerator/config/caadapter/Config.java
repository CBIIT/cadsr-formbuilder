/** THIS FILE IS GENERATED AUTOMATICALLY - DO NOT MODIFY. PLEASE EDIT CONFIG-DEV(CONFIG-DIST).XML INSTEAD
 */
...
public class Config
{
    ...
    public static String CAADAPTER_VERSION = "V1.3";
    public static String CAADAPTER_BUILD_NUMBER = "131";
    public static String RIM_FILE = "@caAdapterFilePath@/etc/Rim207.xml";
    public static String MIF_LOCATION = "@caAdapterFilePath@/MIF/";
    public static String SCHEMA_LOCATION = "@caAdapterFilePath@/schema/multicacheschemas/";
    public static String PORR_MT040001_XML_File = "@caAdapterFilePath@/xml/PORR_MT040001.xml";
    public static String FUNCTION_DEFINITION_FILE_LOCATION = "@caAdapterFilePath@/etc/core.fls";
    ...
    public static int DEFAULT_FIELD_COLUMN_START_NUMBER = 1;
    ...
    public static Color DEFAULT_READ_ONLY_BACK_GROUND_COLOR = Color.LIGHT_GRAY;
    ...
    public static double DEFAULT_PAPER_SIZE_X_IN_INCH = 8.5;
    public static double DEFAULT_PAPER_SIZE_Y_IN_INCH = 11.0;
    public static double DEFAULT_PAPER_TOP_MARGIN_IN_INCH = 0.75;
    public static double DEFAULT_PAPER_BOTTOM_MARGIN_IN_INCH = 0.5;
    public static double DEFAULT_PAPER_LEFT_MARGIN_IN_INCH = 0.75;
    public static double DEFAULT_PAPER_RIGHT_MARGIN_IN_INCH = 0.5;
    public static long DEFAULT_TRANSFORMATION_SERVICE_THRESHOLD_FOR_USER_CONFIRMATION = 120;
    public static long DEFAULT_THRESHOLD_FOR_SECOND_VS_MINUTE = 60;
    public static long DEFAULT_SYNC_VS_ASYNC_THRESHOLD = 10;
