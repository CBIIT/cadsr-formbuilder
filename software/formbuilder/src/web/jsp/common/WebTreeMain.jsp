...
<frameset name="master" rows="126,*" cols="*" framespacing="0" frameborder="no" border="0" bordercolor="0">
  <frame src="<%=treeDir%>skins/<%=skin%>/TopHeader.html" name="headerFrame" frameborder="no" scrolling="no" noresize marginwidth="0" marginheight="0" id="headerFrame">
  <frameset cols="400, *" framespacing="5" frameborder="yes" border="5" bordercolor="#660099">
    <frameset rows="160,*" framespacing="5" frameborder="yes" border="5" bordercolor="#660099">
      <frameset rows="52,*" frameborder="NO" border="0" framespacing="0">
        <frame src="<%=treeDir%>skins/<%=skin%>/SearchHeader.html" name="searchHeader" scrolling="NO" noresize id="searchHeader" >
      ...
      <frameset rows="52,*" frameborder="NO" border="0" framespacing="0">
        <frame src="<%=treeDir%>skins/<%=skin%>/ResultsHeader.html" name="resultsHeader" frameborder="no" scrolling="NO" noresize marginwidth="0" id="resultsHeader" >
        <frame src="SearchResults.jsp?skin=<%=skin%>" name="searchResults" frameborder="no" marginwidth="15" marginheight="10" id="resultsContent">
      </frameset>
    </frameset>
    <frameset rows="52,*" frameborder="NO" border="0" framespacing="0">
      <frame src="<%=treeDir%>skins/<%=skin%>/TreeBrowserHeader.html" name="treeHeader" scrolling="NO" noresize id="treeHeader" >
