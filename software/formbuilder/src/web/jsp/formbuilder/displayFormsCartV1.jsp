...
function saveItems() {
  if (validateSelection('selectedSaveItems','Please select at least one data element to save to your Form Cart.')) {
   document.forms[0].method.value = 'addItemsV1'
   submitForm();
   return true;
  }
}
...
function deleteItems() {
  if (validateSelection('selectedDeleteItems','Please select at least one form to delete from your Form Cart.')) {
    document.forms[0].method.value = 'removeItemsV1'
    submitForm();
  }
}
...
function retrieveSavedItems() {
  document.location.href = "formsCartAction.do?method=displayFormsCartV1";
}
...
<jsp:include page="../common/tab_inc.jsp" flush="true">
  <jsp:param name="label" value="Form&nbsp;Cart V1"/>
