...
<HTML>
  ...
  <BODY topmargin=0 bgcolor="#ffffff">
    ...
    <logic:present name="<%=FormConstants.CRF%>">
        ...
        <logic:present name="<%= FormConstants.CLASSIFICATIONS %>">
          <logic:iterate id="classification" name="<%= FormConstants.CLASSIFICATIONS %>" >
            ...
            <tr class="OraTabledata">
              ...
              <td class="OraFieldText">
              	<bean:write name="classification" property="csContext"/>
              </td>
              <td class="OraFieldText">
              	<bean:write name="classification" property="classSchemeType"/>
              </td>              
              <td class="OraFieldText">
      ...
      <%@ include file="manageClassifications_inc.jsp"%>    
