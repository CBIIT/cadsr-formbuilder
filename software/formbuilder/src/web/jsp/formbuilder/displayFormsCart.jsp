...
<logic:present name="formCartV2">
  <table width="80%" align="center" cellpadding="1" cellspacing="1" border="0" class="OraBGAccentVeryDark">
    <tr class="OraTableColumnHeader">
    <logic:notEmpty name="formCartV2" property = "forms">
  ...
  <logic:empty name="formCartV2" property = "forms">
  ...
  <logic:notEmpty name="formCartV2" property = "forms">
	<bean:size id="noOfItems" name="formCartV2" property="forms" />
    <logic:iterate id="form" name="formCartV2" type="gov.nih.nci.ncicb.cadsr.common.dto.FormTransferObject" property="forms">
<%
...
<logic:notPresent name="formCartV2">
