...
System.out.println("valueMeaningAlterNames.jsp ValueMeaning type [" + vm.getClass().getName() + "]");
System.out.println("valueMeaningAlterNames.jsp ValueMeaning [" + vm + "]");

    List altNames = vm.getDesignations();
    List altDefs = vm.getDefinitions();
    if(altNames != null)
System.out.println("valueMeaningAlterNames.jsp alName size " + altNames.size());
    if(altDefs != null)
System.out.println("valueMeaningAlterNames.jsp alName size " + altDefs.size());
