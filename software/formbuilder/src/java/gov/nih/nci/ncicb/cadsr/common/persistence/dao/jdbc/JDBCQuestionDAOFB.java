...
public class JDBCQuestionDAOFB extends JDBCAdminComponentDAOFB implements QuestionDAO
{
	public JDBCQuestionDAOFB() {
		super();
	}
	...
	public static void main(String[] args) {
		JDBCQuestionDAOFB test = new JDBCQuestionDAOFB();
