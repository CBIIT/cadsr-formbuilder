...
@Component("formValidValueDAO")
public class JDBCFormValidValueDAOFB extends JDBCAdminComponentDAOFB implements FormValidValueDAO
{
	public JDBCFormValidValueDAOFB() {
		super();
	}
	...
	public static void main(String[] args) {
		JDBCFormValidValueDAOFB test = new JDBCFormValidValueDAOFB();
