...
@Component("adminComponentDAO")
public class JDBCAdminComponentDAOFB extends JDBCBaseDAOFB implements AdminComponentDAO
{
  ...
  public JDBCAdminComponentDAOFB() {
    super();
  }
  ...
  private JDBCAdminComponentDAOFB.HasCreateQuery getHasCreateQry() {
  ...
  private JDBCAdminComponentDAOFB.HasDeleteQuery getHasDeleteQry() {
  ...
  private JDBCAdminComponentDAOFB.HasUpdateQuery getHasUpdateQry() {
  ...
  private JDBCAdminComponentDAOFB.PreferredNameGenerator getNameGen() {
    if (nameGen == null) {
