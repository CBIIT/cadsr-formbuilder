...
USING (SELECT 'FormBuilder' AS TOOL_NAME, 'URL' AS PROPERTY, 'https://formbuilder-dev.nci.nih.gov' AS VALUE, 'The URL for the Form Builder Tool connected this caDSR database.' AS DESCRIPTION, 'US' AS LOCALE FROM DUAL
...
UNION SELECT 'FormBuilder' AS TOOL_NAME, 'HELP.ROOT' AS PROPERTY, 'https://formbuilder-dev.nci.nih.gov/help' AS VALUE, 'root url for formbulder tool help' AS DESCRIPTION, 'US' AS LOCALE FROM DUAL
) T
