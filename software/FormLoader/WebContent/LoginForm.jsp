...
<br>
  ...
  <table>
   ...
   <br> If you require an account with curator privileges to a specific context other than Test, please contact CBIIT Application Support Email: <a href='mailto:NCIAppSupport@nih.gov'>NCIAppSupport@nih.gov</a>
      </td>
    </tr>  
    </table>
