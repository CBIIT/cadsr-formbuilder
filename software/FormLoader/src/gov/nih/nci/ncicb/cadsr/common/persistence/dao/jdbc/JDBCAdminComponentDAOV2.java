...
public class JDBCAdminComponentDAOV2 extends JDBCBaseDAOV2
  ...
  public JDBCAdminComponentDAOV2(DataSource dataSource) {
	  super(dataSource);
  }
  ...
  {
     ReferenceAttachmentsQuery query = new ReferenceAttachmentsQuery(this.dataSource);
     return query.execute(refDocId);

  }

  private JDBCAdminComponentDAOV2.HasCreateQuery getHasCreateQry() {
    if (hasCreateQry == null) {
      hasCreateQry = new HasCreateQuery(this.dataSource);
    }

    return hasCreateQry;
  }

  private JDBCAdminComponentDAOV2.HasDeleteQuery getHasDeleteQry() {
    if (hasDeleteQry == null) {
      hasDeleteQry = new HasDeleteQuery(this.dataSource);
    }

    return hasDeleteQry;
  }

  private JDBCAdminComponentDAOV2.HasUpdateQuery getHasUpdateQry() {
    if (hasUpdateQry == null) {
      hasUpdateQry = new HasUpdateQuery(this.dataSource);
    }

    return hasUpdateQry;
  }

  private JDBCAdminComponentDAOV2.PreferredNameGenerator getNameGen() {
    if (nameGen == null) {
      nameGen = new PreferredNameGenerator(this.dataSource);
    }
  ...
  public int assignClassification(
	...
	new InsertAcCsi(this.dataSource);
  ...
  public int removeClassification(String acCsiId) {
    DeleteAcCsi deleteAcCsi =
      new DeleteAcCsi(this.dataSource);
  ...
  public int removeClassification(String cscsiIdseq, String acId) {
    ...
    DeleteCSIForAdminComp deleteAcCsi =
      new DeleteCSIForAdminComp(this.dataSource);
  ...
  public Collection retrieveClassifications(String acId) {
    ...
    classificationQuery.setDataSource(this.dataSource);
...
// Publish ChangeOrder
  ...
  public boolean isClassifiedForPublish(String acId,String conteIdSeq) {
    ...
    PublishClassificationQuery query = new PublishClassificationQuery(this.dataSource);
  ...
  public List getCSIByType(String csType, String csiType, String contextIdseq)
    {
      CSCSIsByTypeQuery query = new CSCSIsByTypeQuery(this.dataSource);
  ...
  public List getAllCSIByType(String csType, String csiType)
    {
      AllCSCSIsByTypeQuery query = new AllCSCSIsByTypeQuery(this.dataSource);
  ...
  public List getCSIForContextId(String contextId)
    {
      ...
      CSCSIsByContextIDQuery query = new CSCSIsByContextIDQuery(this.dataSource);
   ...
   */
   ...
   {
      CSCSIsHierByContextQuery  query = new CSCSIsHierByContextQuery(this.dataSource);
  ...
  public List getCSCSIHierarchyByType(String csType, String csiType)
    {
      ...
      CSCSIsHierQueryByType query = new CSCSIsHierQueryByType(this.dataSource);
      return query.getCSCSIs(csType,csiType);
    }
   /**
    * Gets all CSCSI by type
   ...
   String contextIdseq)
     {
       ...
       CSCSIsHierQueryByTypeAndContext query = new CSCSIsHierQueryByTypeAndContext(this.dataSource);
       return query.getCSCSIs(csType,csiType, contextIdseq);
     }
  ...
  public int designate(String contextIdSeq, List acIdList, String createdBy){
      int res = 0;
       DesignateCDE designateCDE =
          new DesignateCDE(this.dataSource);
    ...
    public boolean isAllACDesignatedToContext(List acIdList, String contextIdSeq){
        CheckACDesignationQuery query = new CheckACDesignationQuery(this.dataSource);
    ...
    * @return Context object.
    ...
    public AdminComponentType getAdminComponentType(String publicId, String version) {
    	...
    	compQry.setDataSource(this.dataSource);
    	compQry.setQuerySql();
   ...
   public List<Contact> getContacts(String acIdseq) {
      ...
      orgQuery.setDataSource(this.dataSource);
    ...
    private class DesignateCDE extends SqlUpdate {
      ...
      protected int designate(
        ...
        if (acIdList == null ||  acIdList.size() == 0){
            logger.info("ac ID list is null or empty list. Nothing is designated.");
            return 0;
        }
        ...
        while (it.hasNext()){
            ...
            try{
              ...
              logger.info("ac ID " + obj[1] + " is already designated to context ID " + contextIdSeq);
            }
            total += res;
        }
        return total;
...
//        " AND   ref.DCTL_NAME = '"+ docType+"'" +
  ...
  private class CSCSIsHierQueryByType extends MappingSqlQuery {
   ...
   public boolean hasRegisteredAC(String cscsiIdseq, String regStatus){
      HasACRegistered hasAC = new HasACRegistered(this.dataSource);
   ...
   public HashMap<String, String> getAllContextSeqIds() {
	   
	   String sql = 
	   		"select distinct CON.NAME, CON.CONTE_IDSEQ from sbr.contexts_view con";
	   	
	   	HashMap<String, String> nameSeqIdMap = new HashMap<String, String>();
   ...
   public int updateWorkflowStatus(String componentSeqid, String newWorkflowStatus, String modifiedBy, String changeNote) {
	   String sql = "UPDATE sbrext.quest_contents_view_ext SET asl_name=:newasl, modified_by=:modifiedby, change_note=:changeNote" +
	   ...
	   params.addValue("changeNote", changeNote);
   ...
   public List<DesignationTransferObject> getDesignationsForForm(String formseqid, String desigName,
	   ...
	   String sql = 
			   "select * from sbr.designations_view " +
					   "where detl_name=:type and lae_name=:language and name=:name and ac_idseq=:formseqid";

	   MapSqlParameterSource params = new MapSqlParameterSource();
	   params.addValue("type", desigType);
	   params.addValue("language", desigLanguage);
	   params.addValue("name", desigName);
