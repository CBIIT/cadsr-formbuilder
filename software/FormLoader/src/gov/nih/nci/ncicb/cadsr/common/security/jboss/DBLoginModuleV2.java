...
import gov.nih.nci.ncicb.cadsr.common.persistence.dao.jdbc.JDBCUserManagerDAOV2;
//import gov.nih.nci.ncicb.cadsr.common.persistence.dao.jdbc.JDBCUserManagerDAOV2;
...
public class DBLoginModuleV2 extends AbstractServerLoginModule {
 
  protected Log logger =  LogFactory.getLog(DBLoginModuleV2.class.getName());
...
public void initialize(Subject p0, CallbackHandler p1, Map p2, Map p3) {
  ...
  {
	   CaDsrUserCredentialsV2 uc = new CaDsrUserCredentialsV2();
	   uc.setDataSource( ((JDBCUserManagerDAOV2)this.userManagerDAO).getDataSource());
	   try
	   {
		  if (appUserName != null)
