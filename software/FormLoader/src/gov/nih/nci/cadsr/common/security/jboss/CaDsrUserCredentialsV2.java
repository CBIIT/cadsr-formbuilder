...
// $Header: /share/content/gforge/cadsrutil/cadsrutil/src/java/gov/nih/nci/ncicb/cadsr/common/security/jboss/CaDsrUserCredentials.java,v 1.2 2008-06-18 19:43:01 hegdes Exp $
 ...
 * @author lhebel
 */
public class CaDsrUserCredentialsV2
{
    /** **/
    ...
    public void initialize(String applUser_, String applPswd_) throws Exception
    {
        ...
        try 
        {
        	if (this.dataSource == null) {
        		_logger.error("ERROR!! DataSource is null.");
        		return;
        		
        	}
            //Context envContext = new InitialContext();
            //DataSource ds = (DataSource)envContext.lookup(_jndiName);
            _conn = this.dataSource.getConnection(_applUser, _applPswd);
