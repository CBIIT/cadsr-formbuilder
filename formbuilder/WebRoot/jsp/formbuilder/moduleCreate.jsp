...
<HTML>
  ...
  <BODY topmargin=0 bgcolor="#ffffff">
    <% String urlPrefix = "";
      ...
      String protoLOVUrl= 
      "javascript:newWin('/formbuilder/formLOVAction.do?method=getProtocolsLOV&idVar=" + FormConstants.PROTOCOLS_LOV_ID_FIELD + "&nameVar=" + FormConstants.PROTOCOLS_LOV_NAME_FIELD +pageUrl+"','protoLOV',900,700)";
      %>
...
<table>
    ...
    <logic:present name="<%=FormConstants.CRF%>">
      ...
      <%@ include file="createModule_inc.jsp"%>    
