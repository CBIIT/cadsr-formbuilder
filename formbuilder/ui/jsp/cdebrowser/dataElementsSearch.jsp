...
<%
  ...
  String csLOVUrl= "javascript:newBrowserWin('" + request.getContextPath() + "/classificationLOVAction.do?method=getClassificationsLOV&classificationsLOV=9&idVar=jspClassification&nameVar=txtClassSchemeItem"+pageUrl+"','csLOV',700,600)";
